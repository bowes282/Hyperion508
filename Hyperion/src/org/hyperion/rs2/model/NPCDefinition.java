    ...
    public static void init() throws IOException {
        ...
        try {
            ...
            while (buffer.hasRemaining()) {
                ...
                definitions[id] = new NPCDefinition(id, name, examine,
                        combatLevel, size, interactionMenu);
            }
        ...
        // definitions[id] = new NPCDefinition(definitions[id].getId(),
        // definitions[id].getName(), examine, definitions[id].getCombatLevel(),
        // definitions[id].getSize(), definitions[id].getInteractionMenu());
        // }
        // }
        // logger.info("Loaded " + definitions.length + " NPC definitions.");
        // } finally {
