...
public abstract class Entity {
     ...
     */
    private Location lastKnownRegion = getLocation();
    /**
    ...
    /**
     * Sets the transform too id.
     *
     * @param transformTo The transform id.
     */
    ...
    /**
     * Sets the force chat text.
     *
     * @param forceText The text.
     */
    ...
    public void setLocation(Location location) {
        ...
        final Region newRegion = World.getWorld().getRegionManager()
