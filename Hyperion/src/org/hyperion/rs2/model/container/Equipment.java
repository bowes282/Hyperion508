...
public class Equipment {
    ...
    public static boolean isTwoHanded(ItemDefinition def) {
        final String wepEquiped = def.getName();
        final int itemId = def.getId();
        if (itemId == 4212) {
            return true;
        } else if (itemId == 4214) {
            return true;
    ...
    /**
     * Gets the weapon stand animation.
     *
     * @param weapon The weapon.
     * @return The animation.
     */
    public static int standAnimation(Item weapon) {
        if (weapon == null) {
            return 0x328;
        }
        final String name = weapon.getDefinition().getName();
        final int itemId = weapon.getId();
        if (itemId == 4718) {
            return 2065;
        } else if (itemId == 4755) {
            return 2061;
            ...
            return 2074;
        } else if (itemId == 6528 || itemId == 1319) {
            return 0x811;
        } else if (name.equals("Saradomin staff")
                || name.equals("Guthix staff") || name.equals("Zamorak staff")) {
            return 0x328;
        } else if (itemId == 4726 || name.endsWith("spear")
                || name.endsWith("halberd") || name.contains("Staff")
                || name.contains("staff") || itemId == 1305) {
            return 809;
        } else if (name.endsWith("2h sword") || name.endsWith("godsword")
    ...
    /**
     * Gets the weapon run animation.
     *
     * @param weapon The weapon.
     * @return The animation.
     */
    public static int runAnimation(Item weapon) {
        if (weapon == null) {
            return 0x338;
        }
        final String name = weapon.getDefinition().getName();
        final int id = weapon.getId();
        if (id == 4718 || name.endsWith("2h sword") || id == 6528
                || name.endsWith("godsword") || name.equals("Saradomin sword")) {
            return 7039;
        } else if (name.equals("Saradomin staff")
                || name.equals("Guthix staff") || name.equals("Zamorak staff")) {
            return 0x338;
            ...
            return 2077;
        } else if (id == 4726 || name.contains("Spear")
                || name.endsWith("halberd") || name.contains("Staff")
                || name.contains("staff")) {
            return 1210;
        } else if (name.equals("Abyssal whip")) {
    ...
    /**
     * Gets the weapon walk animation.
     *
     * @param weapon The weapon.
     * @return The animation.
     */
    public static int walkAnimation(Item weapon) {
        if (weapon == null) {
            return 0x333;
        }
        final String name = weapon.getDefinition().getName();
        final int id = weapon.getId();
        if (name.equals("Saradomin staff") || name.equals("Guthix staff")
                || name.equals("Zamorak staff")) {
            return 0x333;
        } else if (id == 4755) {
            return 2060;
        } else if (id == 4734) {
            ...
            return 1660;
        } else if (id == 4718 || name.endsWith("2h sword") || id == 6528
                || name.endsWith("godsword") || name.equals("Saradomin sword")) {
            return 7046;
        } else if (id == 4726 || name.contains("spear")
                || name.endsWith("halberd") || name.contains("Staff")
