...
public class Class44
{
	...
	if (i == 1) {
	    ...
	    Class21.aPacketStream_466.createFrame(-64, 107);
	    Class21.aPacketStream_466
		.writeByte(32, -1 + class100.method1590((byte) -96));
	    Class21.aPacketStream_466
		.method914((byte) -9, class100.method1615(2, true));
	}
    }
	...
	if ((i_12_ ^ 0xffffffff) != -1) {
		...
		Class61.method595(-6, i, i_6_, i_9_, i_10_);
	    return;
	}
	if ((i_11_ ^ 0xffffffff) > -1)
	    i_11_ = -i_11_;
	...
	int i_24_ = (int) (l - Class81.aLong1495);
	if (i_24_ > 200)
	    i_24_ = 200;
	...
	if (Class22.anInt483 == 0
	    ...
	    return true;
	if (Class68_Sub25.aClass61_3167 == null)
	    return false;
	try {
		...
		class68_sub14.writeByte(32, 1);
		class68_sub14.method918((int) class68_sub20_sub15.aLong1218,
					false);
		Class68_Sub25.aClass61_3167
		    .method590(0, (byte) 34, 4, class68_sub14.aByteArray2960);
		...
		Stream class68_sub14 = new Stream(4);
		class68_sub14.writeByte(32, 0);
		class68_sub14.method918((int) class68_sub20_sub15.aLong1218,
					false);
		Class68_Sub25.aClass61_3167
		    .method590(0, (byte) 88, 4, class68_sub14.aByteArray2960);
		...
		int i_26_ = Class68_Sub25.aClass61_3167.method597((byte) 102);
		...
		if ((i_27_ ^ 0xffffffff) < -1) {
		    int i_28_ = i_27_ + -Class74.aStream_1330.anInt2945;
		    if (i_28_ > i_26_)
			i_28_ = i_26_;
		    Class68_Sub25.aClass61_3167.method591
			(-122, i_28_, Class74.aStream_1330.anInt2945,
			 Class74.aStream_1330.aByteArray2960);
		    if (Class89.aByte1615 != 0) {
			for (int i_29_ = 0;
			     (i_29_ ^ 0xffffffff) > (i_28_ ^ 0xffffffff);
			     i_29_++)
			    Class74.aStream_1330.aByteArray2960
				[i_29_ + Class74.aStream_1330.anInt2945]
		    ...
		    Class74.aStream_1330.anInt2945 += i_28_;
		    if (i_27_ > Class74.aStream_1330.anInt2945)
			break;
		    if (Class68_Sub13_Sub22.aClass68_Sub20_Sub15_3811
			== null) {
			Class74.aStream_1330.anInt2945 = 0;
			int i_30_
			    = Class74.aStream_1330.readUnsignedByte(-6677);
			int i_31_ = Class74.aStream_1330
			...
			Class68_Sub20_Sub15 class68_sub20_sub15
			    = ((Class68_Sub20_Sub15)
			       Class68_Sub20_Sub13.aClass113_4366
				   .method1678(l_34_, 84));
			...
			Class123.aStream_2128
			    = new Stream((Class68_Sub13_Sub22
						 .aClass68_Sub20_Sub15_3811
						 .aByte4391) + i_35_ + i_33_);
			Class123.aStream_2128.writeByte(32, i_32_);
			Class123.aStream_2128.writeDWord(544537784,
							       i_33_);
			Class74.aStream_1330.anInt2945 = 0;
			Class47.anInt942 = 8;
		    } else if ((Class47.anInt942 ^ 0xffffffff) == -1) {
			if (Class74.aStream_1330.aByteArray2960[0]
			    == -1) {
			    Class47.anInt942 = 1;
			    Class74.aStream_1330.anInt2945 = 0;
			} else
		    ...
		    int i_36_
			= (Class123.aStream_2128.aByteArray2960.length
			   + -(Class68_Sub13_Sub22.aClass68_Sub20_Sub15_3811
			       .aByte4391));
		    int i_37_ = 512 - Class47.anInt942;
		    if ((i_36_ + -Class123.aStream_2128.anInt2945
			 ^ 0xffffffff)
			> (i_37_ ^ 0xffffffff))
			i_37_ = i_36_ - Class123.aStream_2128.anInt2945;
		    if ((i_26_ ^ 0xffffffff) > (i_37_ ^ 0xffffffff))
			i_37_ = i_26_;
		    Class68_Sub25.aClass61_3167.method591
			(-60, i_37_, Class123.aStream_2128.anInt2945,
			 Class123.aStream_2128.aByteArray2960);
		    if (Class89.aByte1615 != 0) {
			for (int i_38_ = 0;
			    ...
			    Class123.aStream_2128.aByteArray2960
				[(i_38_
				  + Class123.aStream_2128.anInt2945)]
				= (byte) (Class15.method278
					  ((Class123.aStream_2128
					    .aByteArray2960
					    [i_38_ + (Class123
		    ...
		    Class123.aStream_2128.anInt2945 += i_37_;
			...
			if (((Class68_Sub13_Sub22.aClass68_Sub20_Sub15_3811
				...
				Class68_Sub25.aClass61_3167 = null;
				Class89.aByte1615
	    ...
	    try {
		Class68_Sub25.aClass61_3167.method594(-89);
	    } catch (Exception exception) {
		/* empty */
	    }
	    Class68_Sub25.aClass61_3167 = null;
