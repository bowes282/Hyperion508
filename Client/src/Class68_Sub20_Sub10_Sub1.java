...
public class Class68_Sub20_Sub10_Sub1 extends Class68_Sub20_Sub10
{
	...
	for (int i_0_ = anInt4311 - 1; i_0_ >= 0; i_0_--) {
		...
		is[i++] = anIntArray4615[i_1_ + i_0_ * anInt4309];
	}
	anIntArray4615 = is;
	...
	if (i_6_ > 0 && i_5_ > 0)
	    method1122(Class79.anIntArray1402, anIntArray4615, 0, i_4_, i_3_,
		       i_6_, i_5_, i_7_, i_8_);
    }
	...
	if (i_16_ > 0 && i_15_ > 0)
	    method1128(Class79.anIntArray1402, anIntArray4615, i_14_, i_13_,
	...
	for (int i_23_ = 0; i_23_ < anInt4311; i_23_++) {
		...
		int i_25_ = anIntArray4615[i_22_];
		if (i_25_ == 0) {
		    if (i_24_ > 0 && anIntArray4615[i_22_ - 1] != 0)
			i_25_ = i;
		    else if (i_23_ > 0
			     && anIntArray4615[i_22_ - anInt4309] != 0)
			i_25_ = i;
		    else if (i_24_ < anInt4309 - 1
			     && anIntArray4615[i_22_ + 1] != 0)
			i_25_ = i;
	...
	for (int i_139_ = 0; i_139_ < anInt4311; i_139_++) {
		...
		is[i++] = anIntArray4615[i_140_ + i_139_ * anInt4309];
	}
	anIntArray4615 = is;
	...
	for (int i_169_ = anInt4311 - 1; i_169_ > 0; i_169_--) {
		...
		if (anIntArray4615[i_171_ + i_170_] == 0
		    && anIntArray4615[i_171_ + i_170_ - 1 - anInt4309] != 0)
		    anIntArray4615[i_171_ + i_170_] = i;
	    }
	}
    }
	...
	if (anInt4309 != anInt4305 || anInt4311 != anInt4313) {
		...
		for (int i_193_ = 0; i_193_ < anInt4309; i_193_++)
			...
			= anIntArray4615[i_192_ * anInt4309 + i_193_];
	    }
	    anIntArray4615 = is;
	    anInt4309 = i_190_;
	    anInt4311 = i_191_;
	...
	Class79.method1432(anIntArray4615, anInt4309, anInt4311);
    }
	...
	if (i_195_ > 0 && i_196_ > 0) {
	    ...
	    method1131(Class79.anIntArray1402, anIntArray4615, 0, i_200_,
	...
	if (i_217_ > 0 && i_216_ > 0) {
		...
		for (int i_233_ = -i_228_; i_233_ < 0; i_233_++) {
		    int i_234_ = anIntArray4615[i_215_++];
		    if (i_234_ != 0)
	...
	if (anInt4309 != anInt4305 || anInt4311 != anInt4313) {
		...
		for (int i_243_ = 0; i_243_ < anInt4309; i_243_++)
			...
			= anIntArray4615[i * anInt4309 + i_243_];
	    }
	    anIntArray4615 = is;
	    anInt4309 = anInt4305;
	    anInt4311 = anInt4313;
	...
	for (int i_246_ = 0; i_246_ < anIntArray4615.length; i_246_++) {
	    int i_247_ = anIntArray4615[i_246_];
	    if (i_247_ != 0) {
	...
	if (i_252_ == 256)
		...
		method1134(Class79.anIntArray1402, anIntArray4615, 0, i_255_,
	...
	if (i_342_ > 0 && i_343_ > 0) {
	    ...
	    method1124(Class79.anIntArray1402, anIntArray4615, 0, i_346_,
		       i_347_, i_354_, i_355_, i_342_, i_343_, i_350_, i_351_,
		       i_344_);
	}
    }
    
    public Class68_Sub20_Sub10_Sub1(int i, int i_359_) {
	anIntArray4615 = new int[i * i_359_];
	anInt4309 = anInt4305 = i;
	anInt4311 = anInt4313 = i_359_;
