...
public class Class58
{
	...
	if ((i & 0x100) != 0) {
	    class1_sub6_sub2.anInt2559 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	    class1_sub6_sub2.anInt2518 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    class1_sub6_sub2.anInt2542 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    class1_sub6_sub2.anInt2519 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    class1_sub6_sub2.anInt2550 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544) + Class68_Sub3.anInt2812;
	    class1_sub6_sub2.anInt2521 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA() + Class68_Sub3.anInt2812;
	    class1_sub6_sub2.anInt2588 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    class1_sub6_sub2.anInt2579 = 1;
	    class1_sub6_sub2.anInt2557 = 0;
	}
	if ((i & 0x200) != 0) {
	    int i_2_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    int i_3_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    class1_sub6_sub2.method149(i_2_, false, Class68_Sub3.anInt2812, i_3_);
	}
	if (i_0_ == -19219) {
	    anInt1093++;
	    if ((0x20 & i) != 0) {
		class1_sub6_sub2.anInt2525 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(i_0_ ^ ~0x50cf2dda);
		if (class1_sub6_sub2.anInt2525 == 65535)
		    class1_sub6_sub2.anInt2525 = -1;
	    }
	    if ((0x4 & i) != 0) {
		class1_sub6_sub2.aRSString_2576 = Class68_Sub13_Sub8.aPacketStream_3560.readString(i_0_ ^ ~0x4b6d);
	    ...
	    if ((i & 0x400) != 0) {
		class1_sub6_sub2.anInt2552 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(i_0_ + 1355788763);
		int i_4_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	    ...
	    if ((0x40 & i) != 0) {
		class1_sub6_sub2.anInt2526 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(i_0_ + 19308);
		class1_sub6_sub2.anInt2572 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    }
	    if ((i & 0x8) != 0) {
		int chatTextEffects = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
		boolean bool = (0x8000 & chatTextEffects) != 0;
		int rights = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
		int chatTextSize = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
		int offset = Class68_Sub13_Sub8.aPacketStream_3560.anInt2945;
		if (class1_sub6_sub2.aRSString_3414 != null && class1_sub6_sub2.aClass126_3410 != null) {
		    long l = class1_sub6_sub2.aRSString_3414.method1609(i_0_ + 30127);
			...
			Class95.aStream_1680.anInt2945 = 0;
			Class68_Sub13_Sub8.aPacketStream_3560.method938(0, 0, chatTextSize, Class95.aStream_1680.aByteArray2960);
			Class95.aStream_1680.anInt2945 = 0;
			int i_11_ = -1;
			RSString class100;
			if (!bool)
		...
		Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 = chatTextSize + offset;
	    }
	    if ((0x1 & i) != 0) {
		int i_12_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
		if (i_12_ == 65535)
		    i_12_ = -1;
		int i_13_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
		Class55.method1720(i_13_, i_0_ ^ ~0x4b12, class1_sub6_sub2, i_12_);
	    }
	    if ((i & 0x80) != 0) {
		int i_14_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(i_0_ + 12542);
		byte[] is = new byte[i_14_];
		Stream class68_sub14 = new Stream(is);
		Class68_Sub13_Sub8.aPacketStream_3560.method938(0, 0, i_14_, is);
		Class68_Sub1.aStreamArray2755[i_1_] = class68_sub14;
		class1_sub6_sub2.method159(class68_sub14, (byte) -82);
	    }
	    if ((i & 0x2) != 0) {
		int i_15_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
		int i_16_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
		class1_sub6_sub2.method149(i_15_, false, Class68_Sub3.anInt2812, i_16_);
		class1_sub6_sub2.anInt2534 = 300 + Class68_Sub3.anInt2812;
		class1_sub6_sub2.anInt2547 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    }
	}
    }
	...
	if (i_25_ == 0) {
	    Class21.aPacketStream_466.createFrame(-122, 49);
	    Class68_Sub20_Sub17.anInt4436++;
	    Class21.aPacketStream_466.writeByte(32, i_27_ + i_27_ + 3);
	}
	if (i_25_ == 1) {
	    Class68_Sub27.anInt3210++;
	    Class21.aPacketStream_466.createFrame(-110, 119);
	    Class21.aPacketStream_466.writeByte(32, 14 + (3 + i_27_) - -i_27_);
	}
	if (i_25_ == 2) {
	    Class21.aPacketStream_466.createFrame(76, 138);
	    Class21.aPacketStream_466.writeByte(32, i_27_ + i_27_ + 3);
	    Class68_Sub20_Sub13_Sub2.anInt4618++;
	}
	Class21.aPacketStream_466.writeWordBigEndianA((byte) 19, i_28_ + Class36.anInt643);
	Class21.aPacketStream_466.writeWordA(i_29_ + Class68_Sub13_Sub35.anInt4026, -38);
	Class21.aPacketStream_466.writeByteC(Class128.aBooleanArray2228[82] ? 1 : 0);
	...
	if (i_26_ >= 123) {
		...
		i--;
		Class21.aPacketStream_466.writeByte(32, ((Class68_Sub13_Sub37.anIntArray4066[i]) + -i_28_));
		Class21.aPacketStream_466.writeByteS(-i_29_ + Class68_Sub13_Sub21.anIntArray3797[i]);
	    }
	}
    }
	...
	else if (Class38.anInt677 > i_34_ + -i
