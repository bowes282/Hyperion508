...
public class Class68_Sub28_Sub1 extends Class68_Sub28
{
    ...
    public Class68_Sub26[][] aClass68_Sub26ArrayArray4476
	= new Class68_Sub26[16][128];
    public static int anInt4477;
    public static Class21 aClass21_4478;
	...
	anIntArray4461[i]
	    = (int) ((Math.pow(2.0, (double) i_0_ * 5.4931640625E-4)
		      * (double) i_1_)
		     + 0.5);
	anInt4505++;
    }
	...
	if (aClass10_4467.method213()) {
		...
		int i_4_
		    = (int) ((-1L + (aLong4526 - aLong4528) - -(long) i_3_)
			     / (long) i_3_);
		i_2_ -= i_4_;
	...
	if (class68_sub26.aClass68_Sub28_Sub3_3185 == null) {
		...
		if ((class68_sub26.anInt3179 ^ 0xffffffff) < -1
		    && (aClass68_Sub26ArrayArray4476[class68_sub26.anInt3193]
			[class68_sub26.anInt3179]) == class68_sub26)
		    aClass68_Sub26ArrayArray4476[class68_sub26.anInt3193]
			[class68_sub26.anInt3179]
			= null;
	    }
	    return true;
	}
	...
	anInt4460++;
	int i = ((class68_sub26.anInt3209 * class68_sub26.anInt3181
		  >> 1655033004)
		 + class68_sub26.anInt3189);
	i += ((anIntArray4513[class68_sub26.anInt3193]
	       * (-8192 + anIntArray4465[class68_sub26.anInt3193]))
	      >> -1751757364);
	Class20 class20 = class68_sub26.aClass20_3192;
	if (class20.anInt408 > 0
	    && (class20.anInt417 > 0
		|| anIntArray4473[class68_sub26.anInt3193] > 0)) {
	    ...
	    double d = Math.sin(0.01227184630308513
				* (double) (class68_sub26.anInt3201 & 0x1ff));
	    i += (int) (d * (double) i_8_);
	}
	if (bool != true)
	    return -115;
	int i_10_ = (int) (((double) ((class68_sub26.aClass68_Sub11_Sub1_3204
				       .anInt3447)
				      * 256)
			    * Math.pow(2.0, (double) i * 3.255208333333333E-4)
			    / (double) Class93.anInt1660)
			   + 0.5);
	if (i_10_ < 1)
	    return 1;
	return i_10_;
	...
	if ((0x2 & anIntArray4524[i_11_] ^ 0xffffffff) != -1) {
	    for (Class68_Sub26 class68_sub26
		     = (Class68_Sub26) aClass68_Sub28_Sub2_4527
					   .aClass16_4542.method293((byte) 76);
		 class68_sub26 != null;
		 class68_sub26
		     = (Class68_Sub26) aClass68_Sub28_Sub2_4527
					   .aClass16_4542
					   .method290((byte) -118)) {
		if (i_11_ == class68_sub26.anInt3193
		    && (aClass68_Sub26ArrayArray4511[i_11_]
			[class68_sub26.anInt3198]) == null
	...
	try {
		...
		is = new int[] { i_12_ };
	    boolean bool = true;
	    for (Class68_Sub16 class68_sub16
		     = ((Class68_Sub16)
			class68_sub12.aClass113_2917.method1679(-32642));
		 class68_sub16 != null;
		 class68_sub16
		     = (Class68_Sub16) class68_sub12.aClass113_2917
					   .method1683((byte) -126)) {
		int i_13_ = (int) class68_sub16.aLong1218;
		Class68_Sub27 class68_sub27
		    = ((Class68_Sub27)
		       aClass113_4516.method1678((long) i_13_, 85));
	...
	for (Class68_Sub27 class68_sub27
		 = (Class68_Sub27) aClass113_4516.method1679(-32642);
	     class68_sub27 != null;
	     class68_sub27
		 = (Class68_Sub27) aClass113_4516.method1683((byte) -113))
	...
	if (i_14_ != -1)
	    anIntArray4494 = null;
	for (Class68_Sub26 class68_sub26
		 = (Class68_Sub26) aClass68_Sub28_Sub2_4527.aClass16_4542
				       .method293((byte) 76);
	     class68_sub26 != null;
	     class68_sub26
		 = (Class68_Sub26) aClass68_Sub28_Sub2_4527.aClass16_4542
		...
		if (class68_sub26.aClass68_Sub28_Sub3_3185 != null) {
			...
			.method1288(Class93.anInt1660 / 100);
		    if (class68_sub26.aClass68_Sub28_Sub3_3185.method1278())
			aClass68_Sub28_Sub2_4527.aClass68_Sub28_Sub4_4555
			    .method1316
			    (class68_sub26.aClass68_Sub28_Sub3_3185);
		    class68_sub26.method1214(2);
		}
		if (class68_sub26.anInt3188 < 0)
		    aClass68_Sub26ArrayArray4511[class68_sub26.anInt3193]
	...
	if (i_19_ == 128) {
	    ...
	    if (i_30_ == 0)
		anIntArray4485[i_29_]
		    = (Class120.method1740(anIntArray4485[i_29_], -2080769)
		       - -(i_31_ << 1237724814));
	    if (i_30_ == 32)
		anIntArray4485[i_29_]
		    = ((i_31_ << -928491705)
		       + Class120.method1740(-16257, anIntArray4485[i_29_]));
	    if (i_30_ == 1)
		anIntArray4473[i_29_]
		    = ((i_31_ << -184650553)
		       + Class120.method1740(-16257, anIntArray4473[i_29_]));
	    if (i_30_ == 33)
		anIntArray4473[i_29_]
		    = i_31_ + Class120.method1740(anIntArray4473[i_29_], -128);
	    if ((i_30_ ^ 0xffffffff) == -6)
		anIntArray4489[i_29_]
		    = ((i_31_ << -286745497)
		       + Class120.method1740(-16257, anIntArray4489[i_29_]));
	    if (i_30_ == 37)
		anIntArray4489[i_29_]
		    = i_31_ + Class120.method1740(anIntArray4489[i_29_], -128);
	    if ((i_30_ ^ 0xffffffff) == -8)
		anIntArray4493[i_29_]
		    = ((i_31_ << -367082873)
		       + Class120.method1740(anIntArray4493[i_29_], -16257));
	    if ((i_30_ ^ 0xffffffff) == -40)
		anIntArray4493[i_29_]
		    = (Class120.method1740(anIntArray4493[i_29_], -128)
		       - -i_31_);
	    if ((i_30_ ^ 0xffffffff) == -11)
		anIntArray4495[i_29_]
		    = (Class120.method1740(anIntArray4495[i_29_], -16257)
		       - -(i_31_ << 1132323943));
	    if ((i_30_ ^ 0xffffffff) == -43)
		anIntArray4495[i_29_]
		    = Class120.method1740(-128, anIntArray4495[i_29_]) + i_31_;
	    if (i_30_ == 11)
		anIntArray4459[i_29_]
		    = (Class120.method1740(anIntArray4459[i_29_], -16257)
		       + (i_31_ << -1670563385));
	    if ((i_30_ ^ 0xffffffff) == -44)
		anIntArray4459[i_29_]
		    = (Class120.method1740(-128, anIntArray4459[i_29_])
		       - -i_31_);
	    if (i_30_ == 64) {
		if (i_31_ < 64)
		    anIntArray4524[i_29_]
			= Class120.method1740(anIntArray4524[i_29_], -2);
		else
		    anIntArray4524[i_29_]
			= Class70.method1335(anIntArray4524[i_29_], 1);
	    }
	    if ((i_30_ ^ 0xffffffff) == -66) {
		if ((i_31_ ^ 0xffffffff) <= -65)
		    anIntArray4524[i_29_]
			= Class70.method1335(anIntArray4524[i_29_], 2);
		else {
		    method1234(9773, i_29_);
		    anIntArray4524[i_29_]
			= Class120.method1740(anIntArray4524[i_29_], -3);
		}
	    }
	    if (i_30_ == 99)
		anIntArray4522[i_29_]
		    = ((i_31_ << -794495257)
		       + Class120.method1740(anIntArray4522[i_29_], 127));
	    if ((i_30_ ^ 0xffffffff) == -99)
		anIntArray4522[i_29_]
		    = (Class120.method1740(anIntArray4522[i_29_], 16256)
		       + i_31_);
	    if ((i_30_ ^ 0xffffffff) == -102)
		anIntArray4522[i_29_]
		    = ((i_31_ << -1188631865)
		       + (16384
			  - -Class120.method1740(127, anIntArray4522[i_29_])));
	    if (i_30_ == 100)
		anIntArray4522[i_29_]
		    = (Class120.method1740(anIntArray4522[i_29_], 16256)
		       + 16384 + i_31_);
		...
		if (i_32_ == 16384)
		    anIntArray4513[i_29_]
			= (Class120.method1740(-16257, anIntArray4513[i_29_])
			   + (i_31_ << -1023577145));
	    }
	    if (i_30_ == 38) {
		...
		if (i_33_ == 16384)
		    anIntArray4513[i_29_]
			= (Class120.method1740(-128, anIntArray4513[i_29_])
			   + i_31_);
	    }
	    if ((i_30_ ^ 0xffffffff) == -17)
		anIntArray4501[i_29_]
		    = ((i_31_ << -1921877177)
		       + Class120.method1740(-16257, anIntArray4501[i_29_]));
	    if ((i_30_ ^ 0xffffffff) == -49)
		anIntArray4501[i_29_]
		    = i_31_ + Class120.method1740(-128, anIntArray4501[i_29_]);
	    if ((i_30_ ^ 0xffffffff) == -82) {
		if ((i_31_ ^ 0xffffffff) > -65) {
		    method1254(i_29_, (byte) 86);
		    anIntArray4524[i_29_]
			= Class120.method1740(anIntArray4524[i_29_], -5);
		} else
		    anIntArray4524[i_29_]
			= Class70.method1335(anIntArray4524[i_29_], 4);
	    }
	    if (i_30_ == 17)
		method1230(i_29_, ((~0x3f80 & anIntArray4483[i_29_])
				   - -(i_31_ << 1875579879)), 2097152);
		...
		int i_38_ = i_18_ & 0xf;
		int i_39_ = ((0x7f & i_18_ >> -2001457688)
			     + ((i_18_ & 0x7f01ba) >> 1654521225));
	...
	anInt4462++;
	int i_46_
	    = class68_sub26.aClass68_Sub11_Sub1_3204.aByteArray3445.length;
	if (i <= 18)
	    method1260(null, (byte) 14, -77);
	int i_47_;
	if (!bool || !class68_sub26.aClass68_Sub11_Sub1_3204.aBoolean3446)
	    i_47_ = (int) (((long) anIntArray4501[class68_sub26.anInt3193]
			    * (long) i_46_)
			   >> 456188422);
	else {
	    int i_48_ = (-class68_sub26.aClass68_Sub11_Sub1_3204.anInt3443
			 + i_46_ + i_46_);
	    i_46_ <<= 8;
	    i_47_ = (int) (((long) anIntArray4501[class68_sub26.anInt3193]
			    * (long) i_48_)
	...
	if ((0x2 & anIntArray4524[i]) != 0) {
	    for (Class68_Sub26 class68_sub26
		     = (Class68_Sub26) aClass68_Sub28_Sub2_4527
					   .aClass16_4542
					   .method289(i_55_ ^ 0x7768);
		 class68_sub26 != null;
		 class68_sub26
		     = (Class68_Sub26) aClass68_Sub28_Sub2_4527
					   .aClass16_4542
					   .method280((byte) -75)) {
		if (i == class68_sub26.anInt3193
		    && class68_sub26.anInt3188 < 0) {
		    aClass68_Sub26ArrayArray4511[i][class68_sub26.anInt3198]
			= null;
		    aClass68_Sub26ArrayArray4511[i][i_53_] = class68_sub26;
		    int i_56_
			= (class68_sub26.anInt3189
			   + (class68_sub26.anInt3181 * class68_sub26.anInt3209
			      >> -610093428));
		    class68_sub26.anInt3189
			+= i_53_ + -class68_sub26.anInt3198 << -1786379800;
	...
	Class68_Sub27 class68_sub27
	    = ((Class68_Sub27)
	       aClass113_4516.method1678((long) anIntArray4512[i], 72));
	if (class68_sub27 != null) {
	    Class68_Sub11_Sub1 class68_sub11_sub1
		= class68_sub27.aClass68_Sub11_Sub1Array3213[i_53_];
		...
		class68_sub26.aClass20_3192
		    = class68_sub27.aClass20Array3224[i_53_];
		class68_sub26.anInt3179 = class68_sub27.aByteArray3217[i_53_];
		class68_sub26.anInt3198 = i_53_;
		class68_sub26.anInt3208
		    = (i_54_ * (i_54_
				* (class68_sub27.anInt3221
				   * class68_sub27.aByteArray3212[i_53_]))
		       + 1024) >> 1922857323;
		class68_sub26.anInt3178
		    = 0xff & class68_sub27.aByteArray3222[i_53_];
		class68_sub26.anInt3189
		    = ((i_53_ << 1045251272)
		       - (class68_sub27.aShortArray3211[i_53_] & 0x7fff));
		...
		if (anIntArray4501[i] != 0) {
		    ...
		    method1243(class68_sub26,
			       (class68_sub27.aShortArray3211[i_53_]
				^ 0xffffffff) > -1,
			       (byte) 93);
		} else
		    class68_sub26.aClass68_Sub28_Sub3_3185
		...
		if (i_55_ <= class68_sub26.anInt3179) {
		    Class68_Sub26 class68_sub26_57_
			= (aClass68_Sub26ArrayArray4476[i]
			   [class68_sub26.anInt3179]);
		    if (class68_sub26_57_ != null
			&& class68_sub26_57_.anInt3188 < 0) {
			aClass68_Sub26ArrayArray4511[i][(class68_sub26_57_
							 .anInt3198)]
			    = null;
			class68_sub26_57_.anInt3188 = 0;
		    }
		    aClass68_Sub26ArrayArray4476[i][class68_sub26.anInt3179]
			= class68_sub26;
		}
	...
	for (Class68_Sub27 class68_sub27
	     ...
	     class68_sub27 != null;
	     class68_sub27
		 = (Class68_Sub27) aClass113_4516.method1683((byte) -114))
	...
	if (class68_sub26 != null) {
		...
		for (Class68_Sub26 class68_sub26_61_
			 = (Class68_Sub26) aClass68_Sub28_Sub2_4527
					       .aClass16_4542
					       .method293((byte) 76);
			 ...
			 = (Class68_Sub26) aClass68_Sub28_Sub2_4527
					       .aClass16_4542
					       .method290((byte) 42)) {
		    if (class68_sub26.anInt3193 == class68_sub26_61_.anInt3193
			&& class68_sub26_61_.anInt3188 < 0
			&& class68_sub26 != class68_sub26_61_) {
			class68_sub26.anInt3188 = 0;
			break;
		    }
		}
	...
	Class68_Sub20_Sub7 class68_sub20_sub7
	    = ((Class68_Sub20_Sub7)
	       Class68_Sub6.aLogin_2844.method1473((long) i, (byte) -76));
	anInt4514++;
	...
	for (Class68_Sub26 class68_sub26
		 ...
		 = (Class68_Sub26) aClass68_Sub28_Sub2_4527.aClass16_4542
				       .method290((byte) -121)) {
	    if ((i < 0 || class68_sub26.anInt3193 == i)
		&& class68_sub26.anInt3188 < 0) {
		aClass68_Sub26ArrayArray4511[class68_sub26.anInt3193]
		    [class68_sub26.anInt3198]
		    = null;
	...
	try {
	    ...
	    if (class68_sub26.anInt3188 >= 0
		&& (class68_sub26.aClass68_Sub28_Sub3_3185 == null
		    || class68_sub26.aClass68_Sub28_Sub3_3185.method1295())) {
		class68_sub26.method1214(2);
		class68_sub26.method647(i_65_ + -17486);
		if ((class68_sub26.anInt3179 ^ 0xffffffff) < -1
		    && class68_sub26 == (aClass68_Sub26ArrayArray4476
		...
		if (class20.anInt418 <= 0)
		    ...
		    class68_sub26.anInt3199
			+= (int) ((128.0
				   * Math.pow(2.0,
					      d * (double) class20.anInt418))
				  + 0.5);
		for (/**/;
		     ((-2 + class20.aByteArray407.length
		       > class68_sub26.anInt3187)
		      && ((0xff00 & ((class20.aByteArray407
				      [class68_sub26.anInt3187 + 2])
				     << -1967673784)
			   ^ 0xffffffff)
			  > (class68_sub26.anInt3199 ^ 0xffffffff)));
		     class68_sub26.anInt3187 += 2) {
		    /* empty */
		}
		if (((class20.aByteArray407.length + -2 ^ 0xffffffff)
		     == (class68_sub26.anInt3187 ^ 0xffffffff))
		    && (class20.aByteArray407[class68_sub26.anInt3187 - -1]
			== 0))
		    bool = true;
	    }
	    if ((class68_sub26.anInt3188 ^ 0xffffffff) <= -1
		&& class20.aByteArray405 != null
		&& (anIntArray4524[class68_sub26.anInt3193] & 0x1) == 0
		&& ((class68_sub26.anInt3179 ^ 0xffffffff) > -1
		    || (aClass68_Sub26ArrayArray4476[class68_sub26.anInt3193]
			[class68_sub26.anInt3179]) != class68_sub26)) {
		if (class20.anInt414 > 0)
		    class68_sub26.anInt3188
			+= (int) ((128.0
				   * Math.pow(2.0,
					      (double) class20.anInt414 * d))
				  + 0.5);
		else
		    class68_sub26.anInt3188 += 128;
		for (/**/;
		     ((-2 + class20.aByteArray405.length
		       > class68_sub26.anInt3197)
		      && ((class68_sub26.anInt3188 ^ 0xffffffff)
			  < (((class20.aByteArray405
			       [2 + class68_sub26.anInt3197]) << 901730312
			      & 0xff00)
			     ^ 0xffffffff)));
		     class68_sub26.anInt3197 += 2) {
		    /* empty */
		}
		if (class68_sub26.anInt3197
		    == class20.aByteArray405.length - 2)
		    bool = true;
	    }
	    if (bool) {
		class68_sub26.aClass68_Sub28_Sub3_3185
		    .method1288(class68_sub26.anInt3196);
		if (is != null)
		    class68_sub26.aClass68_Sub28_Sub3_3185
			.method1225(is, i_64_, i);
		else
		    class68_sub26.aClass68_Sub28_Sub3_3185.method1229(i);
		if (class68_sub26.aClass68_Sub28_Sub3_3185.method1278())
		    aClass68_Sub28_Sub2_4527.aClass68_Sub28_Sub4_4555
			.method1316(class68_sub26.aClass68_Sub28_Sub3_3185);
		class68_sub26.method1214(2);
		if (class68_sub26.anInt3188 >= 0) {
		    class68_sub26.method647(-17554);
		    if ((class68_sub26.anInt3179 ^ 0xffffffff) < -1
			&& class68_sub26 == (aClass68_Sub26ArrayArray4476
					     [class68_sub26.anInt3193]
					     [class68_sub26.anInt3179]))
			aClass68_Sub26ArrayArray4476
			    [class68_sub26.anInt3193][class68_sub26.anInt3179]
			    = null;
		}
		return true;
	    }
	    class68_sub26.aClass68_Sub28_Sub3_3185.method1289
		(class68_sub26.anInt3196,
	...
	if (aClass10_4467.method213()) {
		...
		int i_68_
		    = (int) ((-1L + (long) i_67_ + (-aLong4528 + aLong4526))
			     / (long) i_67_);
		i -= i_68_;
	...
	anInt4479++;
	int i_71_ = ((anIntArray4493[class68_sub26.anInt3193]
		      * anIntArray4459[class68_sub26.anInt3193]) - -4096
		     >> 184148909);
	Class20 class20 = class68_sub26.aClass20_3192;
	...
	if (class20.anInt409 > 0)
	    i_71_ = (int) ((Math.pow(0.5, (1.953125E-5
					   * (double) class68_sub26.anInt3202
					   * (double) class20.anInt409))
			    * (double) i_71_)
			   + 0.5);
	if (class20.aByteArray407 != null) {
	    int i_72_ = class20.aByteArray407[1 + class68_sub26.anInt3187];
	    int i_73_ = class68_sub26.anInt3199;
	    if ((class68_sub26.anInt3187 ^ 0xffffffff)
		> (-2 + class20.aByteArray407.length ^ 0xffffffff)) {
		int i_74_ = ((class20.aByteArray407[class68_sub26.anInt3187]
			      << 1607012936)
			     & 0xff00);
		int i_75_ = (class20.aByteArray407[2 + class68_sub26.anInt3187]
			     & 0xff) << -225091064;
		i_72_
		    += ((-i_72_
			 + class20.aByteArray407[class68_sub26.anInt3187 - -3])
			* (i_73_ - i_74_) / (i_75_ + -i_74_));
	    }
	...
	if (class68_sub26.anInt3188 > 0 && class20.aByteArray405 != null) {
		...
		int i_78_ = ((class20.aByteArray405[class68_sub26.anInt3197]
			      << 1523540488)
			     & 0xff00);
		int i_79_ = (class20.aByteArray405[2 + class68_sub26.anInt3197]
			     & 0xff) << -598009848;
		i_77_ += (class20.aByteArray405[3 + class68_sub26.anInt3197]
			  - i_77_) * (-i_78_ + i_76_) / (-i_78_ + i_79_);
	    }
	...
	return (-(32 + (128 - class68_sub26.anInt3178) * (16384 - i_80_)
		  >> 224148710)
		+ 16384);
    }
    ...
    public static void method1260(Class68_Sub29 class68_sub29, byte i,
				  int i_83_) {
	anInt4499++;
	Object[] objects = class68_sub29.anObjectArray3237;
	int i_84_ = ((Integer) objects[0]).intValue();
	Class68_Sub20_Sub14 class68_sub20_sub14
	    = Class68_Sub13_Sub17.method784(i_84_, (byte) 109);
	if (class68_sub20_sub14 != null) {
	    ...
	    try {
		int i_90_ = 0;
		Class68_Sub29.aRSStringArray3248
		    = new RSString[class68_sub20_sub14.anInt4370];
		Class94.anIntArray1677
		    = new int[class68_sub20_sub14.anInt4379];
		int i_91_ = 0;
		for (int i_92_ = 1;
			...
			if (objects[i_92_] instanceof RSString) {
			    ...
			    if (class100.method1593((Class68_Sub25
						     .aRSString_3171),
						    (byte) 101))
				class100 = class68_sub29.aRSString_3234;
			    Class68_Sub29.aRSStringArray3248[i_91_++]
				= class100;
			}
		    } else {
		...
		for (;;) {
			...
			if (i_87_ == 3) {
			    Class68_Sub15.aRSStringArray3015[i_89_++]
				= (class68_sub20_sub14.aRSStringArray4375
				   [i_86_]);
			    continue;
			}
			...
			if (i_87_ == 10) {
			    i_85_ -= 2;
			    if ((Class68_Sub13.anIntArray2924[i_85_]
				 ^ 0xffffffff)
			...
			if (i_87_ == 21) {
				...
				Class43 class43
				    = (Class68_Sub13_Sub9.aClass43Array3570
				       [--Class76.anInt1355]);
				i_86_ = class43.anInt736;
				Class68_Sub29.aRSStringArray3248
				    = class43.aRSStringArray738;
				Class94.anIntArray1677 = class43.anIntArray731;
				class68_sub20_sub14
				    = class43.aClass68_Sub20_Sub14_733;
			...
			if (i_87_ == 25) {
			    int i_97_ = is[i_86_];
			    Class68_Sub13.anIntArray2924[i_85_++]
				= Class18.method300(i_97_, false);
			    continue;
			}
			if ((i_87_ ^ 0xffffffff) == -28) {
			    int i_98_ = is[i_86_];
			    Class102.method1629(i_98_, 0,
						(Class68_Sub13.anIntArray2924
						 [--i_85_]));
			    continue;
			}
			if (i_87_ == 31) {
			...
			if ((i_87_ ^ 0xffffffff) == -34) {
			    Class68_Sub13.anIntArray2924[i_85_++]
				= Class94.anIntArray1677[is[i_86_]];
			    continue;
			}
			...
			if (i_87_ == 35) {
			    Class68_Sub15.aRSStringArray3015[i_89_++]
				= Class68_Sub29.aRSStringArray3248[is[i_86_]];
			    continue;
			}
			if (i_87_ == 36) {
			    Class68_Sub29.aRSStringArray3248[is[i_86_]]
			...
			if ((i_87_ ^ 0xffffffff) == -38) {
			    ...
			    i_89_ -= i_99_;
			    RSString class100
				= (Class68_Sub20_Sub10.method1106
				   (true, i_89_,
				    Class68_Sub15.aRSStringArray3015, i_99_));
			    Class68_Sub15.aRSStringArray3015[i_89_++]
				= class100;
			    continue;
			}
			...
			if (i_87_ == 40) {
				...
				= Class68_Sub13_Sub17.method784(i_100_,
								(byte) 61);
			    int[] is_102_
				= new int[class68_sub20_sub14_101_.anInt4379];
			    RSString[] class100s
				= (new RSString
				   [class68_sub20_sub14_101_.anInt4370]);
			    for (int i_103_ = 0;
				...
				is_102_[i_103_]
				    = (Class68_Sub13.anIntArray2924
				       [(i_85_
					 + (-class68_sub20_sub14_101_.anInt4373
					    + i_103_))]);
			    for (int i_104_ = 0;
				 ((i_104_ ^ 0xffffffff)
				  > (class68_sub20_sub14_101_.anInt4371
				     ^ 0xffffffff));
				 i_104_++)
				class100s[i_104_]
				    = (Class68_Sub15.aRSStringArray3015
				       [i_104_ + (i_89_
						  - (class68_sub20_sub14_101_
						     .anInt4371))]);
			    ...
			    class43.aRSStringArray738
				= Class68_Sub29.aRSStringArray3248;
			    if (Class68_Sub13_Sub9.aClass43Array3570.length
				<= Class76.anInt1355)
			...
			if ((i_87_ ^ 0xffffffff) == -43) {
			    Class68_Sub13.anIntArray2924[i_85_++]
				= Class106.anIntArray1809[is[i_86_]];
			    continue;
			}
			if ((i_87_ ^ 0xffffffff) == -44) {
			    int i_105_ = is[i_86_];
			    Class106.anIntArray1809[i_105_]
				= Class68_Sub13.anIntArray2924[--i_85_];
			...
			if ((i_87_ ^ 0xffffffff) == -45) {
				...
				|| (i_108_ ^ 0xffffffff) < -5001)
				throw new RuntimeException();
			    Class68_Sub13_Sub31.anIntArray3969[i_106_]
				= i_108_;
			    int i_109_ = -1;
			    if (i_107_ == 105)
				i_109_ = 0;
			    for (int i_110_ = 0; i_110_ < i_108_; i_110_++)
				Class75_Sub3_Sub1.anIntArrayArray4601
				    [i_106_][i_110_]
				    = i_109_;
			    continue;
			}
			if (i_87_ == 45) {
				...
				|| (Class68_Sub13_Sub31.anIntArray3969[i_111_]
				    <= i_112_))
				throw new RuntimeException();
			    Class68_Sub13.anIntArray2924[i_85_++]
				= (Class75_Sub3_Sub1.anIntArrayArray4601
			...
			if (i_87_ == 46) {
			    ...
			    int i_114_ = is[i_86_];
			    if (i_113_ < 0
				|| i_113_ >= (Class68_Sub13_Sub31
					      .anIntArray3969[i_114_]))
				throw new RuntimeException();
			    Class75_Sub3_Sub1.anIntArrayArray4601[i_114_]
				[i_113_]
				= Class68_Sub13.anIntArray2924[i_85_ + 1];
			    continue;
			}
			if (i_87_ == 47) {
			    RSString class100
				= Class21_Sub1.aRSStringArray2710[is[i_86_]];
			    if (class100 == null)
			...
			if ((i_87_ ^ 0xffffffff) == -49) {
			    int i_115_ = is[i_86_];
			    Class21_Sub1.aRSStringArray2710[i_115_]
				= Class68_Sub15.aRSStringArray3015[--i_89_];
			...
			if ((i_87_ ^ 0xffffffff) == -52) {
			    Class113 class113
				= (class68_sub20_sub14.aClass113Array4380
				   [is[i_86_]]);
			    Class68_Sub10 class68_sub10
				= ((Class68_Sub10)
				   class113.method1678((long) (Class68_Sub13
							       .anIntArray2924
							       [--i_85_]),
						       -86));
			...
			if (i_87_ >= 300) {
				...
				if (i_87_ == 403) {
				    ...
				    if (i_116_ >= 7)
					i_116_ -= 7;
				    int i_117_ = (Class68_Sub13.anIntArray2924
						  [1 + i_85_]);
				    Class68_Sub7.aClass1_Sub6_Sub2_2860
					.aClass126_3410
					.method1772(i_116_, i_117_, -27345);
				    break;
				}
				if ((i_87_ ^ 0xffffffff) == -405) {
				    ...
				    int i_118_
					= Class68_Sub13.anIntArray2924[i_85_];
				    int i_119_ = (Class68_Sub13.anIntArray2924
						  [i_85_ + 1]);
				    Class68_Sub7.aClass1_Sub6_Sub2_2860
					.aClass126_3410
					.method1769(i_118_, 41, i_119_);
				    break;
				}
				if ((i_87_ ^ 0xffffffff) == -411) {
				    ...
				    Class68_Sub7.aClass1_Sub6_Sub2_2860
					.aClass126_3410
					.method1767(bool_120_, 87);
				    break;
				}
			    } else if (((i_87_ ^ 0xffffffff) <= -1001
					&& i_87_ < 1100)
				       || i_87_ >= 2000 && i_87_ < 2100) {
				Class45 class45;
				if (i_87_ >= 2000) {
				    i_87_ -= 1000;
				    class45 = (Class68_Sub20_Sub15.method1170
					       ((Class68_Sub13.anIntArray2924
						 [--i_85_]),
						(byte) -80));
				} else
				...
				if (i_87_ == 1000) {
					...
					= (Class68_Sub13.anIntArray2924
					   [i_85_ + 1]);
				    int i_121_ = (Class68_Sub13.anIntArray2924
						  [2 + i_85_]);
				    int i_122_ = (Class68_Sub13.anIntArray2924
						  [i_85_ - -3]);
				...
				if ((i_87_ ^ 0xffffffff) == -1002) {
				    ...
				    class45.anInt883 = 0;
				    class45.anInt793 = 0;
				    int i_123_ = (Class68_Sub13.anIntArray2924
						  [2 + i_85_]);
				    int i_124_ = (Class68_Sub13.anIntArray2924
						  [3 + i_85_]);
			    ...
			    } else if (((i_87_ ^ 0xffffffff) > -1101
					|| i_87_ >= 1200)
				       && ((i_87_ ^ 0xffffffff) > -2101
					   || i_87_ >= 2200)) {
				if ((i_87_ < 1200
				     || (i_87_ ^ 0xffffffff) <= -1301)
				    && (i_87_ < 2200
					|| (i_87_ ^ 0xffffffff) <= -2301)) {
				    if (((i_87_ ^ 0xffffffff) > -1301
					 || (i_87_ ^ 0xffffffff) <= -1401)
					&& ((i_87_ ^ 0xffffffff) > -2301
					    || ((i_87_ ^ 0xffffffff)
						<= -2401))) {
					if (((i_87_ ^ 0xffffffff) <= -1401
					     && i_87_ < 1500)
					    || ((i_87_ ^ 0xffffffff) <= -2401
						&& i_87_ < 2500)) {
					    Class45 class45;
					    if (i_87_ < 2000)
						class45
						...
						objects_128_[0]
						    = new Integer(i_130_);
					    if (i_87_ == 1400)
						class45.anObjectArray788
						    = objects_128_;
					    else if (i_87_ != 1401) {
						if ((i_87_ ^ 0xffffffff)
						    == -1403)
						    class45.anObjectArray790
							= objects_128_;
						else if (i_87_ != 1403) {
						    if ((i_87_ ^ 0xffffffff)
							!= -1405) {
						    ...
						    class45.anObjectArray784
							= objects_128_;
					    } else
						class45.anObjectArray821
						    = objects_128_;
						...
						if (i_87_ >= 2600) {
							...
							if (i_87_ < 2800) {
								...
								if ((class45
								    ...
								    int i_132_
									= (class45
									   .aClass45Array769).length;
								    for (int i_133_
									     = 0;
									 (i_133_
									  < class45.aClass45Array769.length);
									 i_133_++) {
									if ((class45
									     .aClass45Array769
									     [i_133_])
								...
								if (i_87_
									...
									if ((i_87_
										...
										if ((i_87_ ^ 0xffffffff) > -4201) {
											...
											RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
											int i_150_ = Class68_Sub13.anIntArray2924[--i_85_];
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub13_Sub2.method1166(2, new RSString[] { class100, Class68_Sub13_Sub24.method816(i_150_, 0) });
											break;
										    }
										    if (i_87_ == 4101) {
											i_89_ -= 2;
											RSString class100 = Class68_Sub15.aRSStringArray3015[i_89_];
											RSString class100_151_ = Class68_Sub15.aRSStringArray3015[1 + i_89_];
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub13_Sub2.method1166(2, new RSString[] { class100, class100_151_ });
											break;
										    }
										    if (i_87_ == 4102) {
											int i_152_ = Class68_Sub13.anIntArray2924[--i_85_];
											RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub13_Sub2.method1166(2, new RSString[] { class100, Class44.method490(true, (byte) 42, i_152_) });
											break;
										    }
										    if (i_87_ == 4103) {
											RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
											Class68_Sub15.aRSStringArray3015[i_89_++] = class100.method1608((byte) -90);
											break;
										    }
											...
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub13_Sub2.method1166(2, new RSString[] { Class68_Sub13_Sub24.method816(i_154_, 0), Class32.aRSString_566, Class50_Sub2.aRSStringArray2740[i_155_], Class32.aRSString_566, Class68_Sub13_Sub24.method816(i_156_, 0) });
											break;
										    }
										    if ((i_87_ ^ 0xffffffff) == -4106) {
											i_89_ -= 2;
											RSString class100 = Class68_Sub15.aRSStringArray3015[i_89_];
											RSString class100_157_ = Class68_Sub15.aRSStringArray3015[i_89_ + 1];
											if (Class68_Sub7.aClass1_Sub6_Sub2_2860.aClass126_3410 == null || !Class68_Sub7.aClass1_Sub6_Sub2_2860.aClass126_3410.aBoolean2196)
											    Class68_Sub15.aRSStringArray3015[i_89_++] = class100;
											else
											    Class68_Sub15.aRSStringArray3015[i_89_++] = class100_157_;
											break;
										    }
										    if (i_87_ == 4106) {
											int i_158_ = Class68_Sub13.anIntArray2924[--i_85_];
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub13_Sub24.method816(i_158_, 0);
											break;
										    }
										    if (i_87_ == 4107) {
											i_89_ -= 2;
											Class68_Sub13.anIntArray2924[i_85_++] = Class68_Sub15.aRSStringArray3015[i_89_].method1601((byte) -39, Class68_Sub15.aRSStringArray3015[i_89_ + 1]);
											break;
										    }
											...
											i_89_ -= 2;
											RSString class100 = Class68_Sub15.aRSStringArray3015[1 + i_89_];
											RSString class100_165_ = Class68_Sub15.aRSStringArray3015[i_89_];
											if (Class68_Sub13.anIntArray2924[--i_85_] != 1)
											    Class68_Sub15.aRSStringArray3015[i_89_++] = class100;
											else
											    Class68_Sub15.aRSStringArray3015[i_89_++] = class100_165_;
											break;
										    }
										    if ((i_87_ ^ 0xffffffff) == -4112) {
											RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub1.method1009(class100);
											break;
										    }
											...
											Class68_Sub15.aRSStringArray3015[i_89_++] = class100.method1576((byte) 115, i_166_);
											break;
										    }
											...
											Class68_Sub15.aRSStringArray3015[i_89_++] = class100.method1607(i_171_, (byte) -74, i_172_);
											break;
										    }
										    if ((i_87_ ^ 0xffffffff) == -4120) {
											RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
											RSString class100_173_ = Class21.method339(i ^ ~0x4a59, class100.method1590((byte) -100));
											...
											Class68_Sub15.aRSStringArray3015[i_89_++] = class100_173_;
											break;
										    }
											...
											i_89_ -= 2;
											RSString class100 = Class68_Sub15.aRSStringArray3015[i_89_];
											RSString class100_179_ = Class68_Sub15.aRSStringArray3015[i_89_ - -1];
											...
											Class68_Sub15.aRSStringArray3015[i_89_++] = Applet_Sub1.method18(-25672, i_183_).aRSString_362;
											break;
										    }
										    if (i_87_ == 4201) {
											i_85_ -= 2;
											...
											if ((i_185_ ^ 0xffffffff) <= -2 && i_185_ <= 5 && class19.aRSStringArray369[-1 + i_185_] != null)
											    Class68_Sub15.aRSStringArray3015[i_89_++] = class19.aRSStringArray369[-1 + i_185_];
											else
											    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub13_Sub19.aRSString_3739;
											break;
										    }
										    if (i_87_ == 4202) {
											i_85_ -= 2;
											...
											if ((i_187_ ^ 0xffffffff) <= -2 && (i_187_ ^ 0xffffffff) >= -6 && class19.aRSStringArray340[-1 + i_187_] != null)
											    Class68_Sub15.aRSStringArray3015[i_89_++] = class19.aRSStringArray340[i_187_ + -1];
											else
											    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub13_Sub19.aRSString_3739;
											break;
										    }
											...
											if (!class68_sub20_sub12.method1155(115))
											    ...
											    Class68_Sub15.aRSStringArray3015[i_89_++] = Applet_Sub1.method18(-25672, i_193_).method312(class68_sub20_sub12.aRSString_4344, (byte) 21, i_194_);
											break;
										    }
											...
											if (i_87_ >= 4600) {
												...
												if (i_87_ < 5200) {
													...
													Class72.method1354(Class68_Sub15.aRSStringArray3015[--i_89_], -1);
													break;
												    }
												    if (i_87_ == 5204) {
													Class68_Sub15.aRSStringArray3015[-1 + i_89_] = Class115.method1698(Class68_Sub15.aRSStringArray3015[-1 + i_89_], 14589);
													break;
												    }
												    if ((i_87_ ^ 0xffffffff) == -5206) {
													Class68_Sub13_Sub23.method814((byte) 37, Class68_Sub15.aRSStringArray3015[--i_89_]);
													break;
												    }
													...
													if (class68_sub20_sub16 == null)
													    ...
													    Class68_Sub15.aRSStringArray3015[i_89_++] = class68_sub20_sub16.aRSString_4412;
													break;
												    }
												    if ((i_87_ ^ 0xffffffff) == -5208) {
													Class68_Sub20_Sub16 class68_sub20_sub16 = Class68_Sub13_Sub7.method726((byte) -94, Class68_Sub15.aRSStringArray3015[--i_89_]);
													if (class68_sub20_sub16 != null && class68_sub20_sub16.aRSString_4429 != null)
													    Class68_Sub15.aRSStringArray3015[i_89_++] = class68_sub20_sub16.aRSString_4429;
													else
													    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub13_Sub19.aRSString_3739;
													break;
												    }
													...
													if (i_87_ == 5400) {
													    ...
													    i_89_ -= 2;
													    RSString class100 = Class68_Sub15.aRSStringArray3015[i_89_];
													    RSString class100_198_ = Class68_Sub15.aRSStringArray3015[i_89_ + 1];
													    Class21.aPacketStream_466.createFrame(i ^ ~0x46, 161);
													    Class21.aPacketStream_466.writeByte(i + -92, Class13_Sub1.method250(class100, -125) + (Class13_Sub1.method250(class100_198_, -110) + 1));
													    Class21.aPacketStream_466.method914((byte) -9, class100);
													    Class21.aPacketStream_466.method914((byte) -9, class100_198_);
													    Class21.aPacketStream_466.writeByte(32, i_197_);
													    break;
													}
													...
													if ((i_87_ ^ 0xffffffff) == -5420) {
														...
														class100 = Class1_Sub7.method165(Class68_Sub10.aClass31_2914.anInt559, -17516);
														try {
														    if (Class68_Sub10.aClass31_2914.anObject558 != null) {
															byte[] is_209_ = ((String) Class68_Sub10.aClass31_2914.anObject558).getBytes("ISO-8859-1");
													...
													if ((i_87_ ^ 0xffffffff) == -5423) {
													    i_89_ -= 2;
													    RSString class100 = Class68_Sub15.aRSStringArray3015[i_89_];
													    RSString class100_211_ = Class68_Sub15.aRSStringArray3015[i_89_ + 1];
													...
													if (i_87_ == 5600) {
													    ...
													    RSString class100 = Class68_Sub15.aRSStringArray3015[1 + i_89_];
													    RSString class100_226_ = Class68_Sub15.aRSStringArray3015[i_89_];
													    if (RuntimeException_Sub1.anInt2231 == 10) {
														if (Class32.anInt574 == 0 && Class68_Sub13_Sub27.anInt3914 == 0)
														    Class16.method283(class100, i ^ 0x4a, class100_226_, i_225_);
													    }
													    break;
													}
													...
													if (i_87_ == 5604) {
													    ...
													    if (RuntimeException_Sub1.anInt2231 == 10) {
														if ((Class32.anInt574 ^ 0xffffffff) == -1 && (Class68_Sub13_Sub27.anInt3914 ^ 0xffffffff) == -1)
														    Class81.method1456(-3, Class68_Sub15.aRSStringArray3015[i_89_].method1609(10908));
													    }
													    break;
													}
													if (i_87_ == 5605) {
													    ...
													    if (RuntimeException_Sub1.anInt2231 == 10) {
														if ((Class32.anInt574 ^ 0xffffffff) == -1 && (Class68_Sub13_Sub27.anInt3914 ^ 0xffffffff) == -1)
														    Class74.method1384(Class68_Sub15.aRSStringArray3015[i_89_].method1609(i ^ 0x2ae0), Class68_Sub13.anIntArray2924[i_85_], i ^ 0x28, Class68_Sub13.anIntArray2924[1 + i_85_], Class68_Sub15.aRSStringArray3015[i_89_ + 1], Class68_Sub13.anIntArray2924[3 + i_85_], Class68_Sub13.anIntArray2924[i_85_ + 2]);
													    }
													    break;
													}
													if (i_87_ == 5606) {
													...
													if ((i_87_ ^ 0xffffffff) == -5611) {
														...
														Class68_Sub15.aRSStringArray3015[i_89_++] = (Class68_Sub8.aRSStringArray2872.length ^ 0xffffffff) >= (i_227_ ^ 0xffffffff) ? Class68_Sub13_Sub19.aRSString_3739 : Class68_Sub8.aRSStringArray2872[i_227_];
													...
													if (i_87_ < 6200) {
														...
														Class68_Sub13.anIntArray2924[i_85_++] = Class81.aBoolean1487 ? 1 : 0;
														break;
													    }
														...
														if ((i_87_ ^ 0xffffffff) > -6501) {
														    ...
														    if (i_87_ == 6403) {
															Class68_Sub15.aRSStringArray3015[i_89_++] = Applet_Sub1.aRSString_31;
															break;
														    }
														    if (i_87_ == 6404) {
															Class68_Sub15.aRSStringArray3015[i_89_++] = Class13.aRSString_215;
															break;
														    }
														    if (i_87_ == 6405) {
															...
															Class68_Sub13.anIntArray2924[i_85_++] = Class81.method1460(-15855) ? 1 : 0;
															break;
														    }
														}
													    } else {
													...
													if (i_87_ == 6005) {
													    Class81.aBoolean1487 = Class68_Sub13.anIntArray2924[--i_85_] == 1;
													...
													if (i_87_ == 6019) {
														...
														if ((Class68_Sub13_Sub25.anInt3855 ^ 0xffffffff) == -1 && Class101.anInt1745 != -1) {
														    Class68_Sub13_Sub38.method899(Class101.anInt1745, Class21.aClass21_Sub1_459, false, 0, i_238_, false);
												...
												if (i_87_ == 5000) {
												    Class68_Sub13.anIntArray2924[i_85_++] = Class38.anInt686;
												    break;
												}
												if ((i_87_ ^ 0xffffffff) == -5002) {
												    Class125.anInt2177++;
												    i_85_ -= 3;
												    Class38.anInt686 = Class68_Sub13.anIntArray2924[i_85_];
												    ...
												    Class21.aPacketStream_466.createFrame(-87, 212);
												    Class21.aPacketStream_466.writeByte(32, Class38.anInt686);
												    Class21.aPacketStream_466.writeByte(32, Class68_Sub13_Sub4.anInt3497);
												    Class21.aPacketStream_466.writeByte(32, Class68_Sub4.anInt2813);
												    break;
												}
												if ((i_87_ ^ 0xffffffff) == -5003) {
												    ...
												    Class21.aPacketStream_466.createFrame(i + -15, 159);
												    Class21.aPacketStream_466.method924(true, class100.method1609(10908));
												    Class21.aPacketStream_466.writeByte(32, -1 + i_240_);
												    Class21.aPacketStream_466.writeByte(32, i_241_);
												    break;
												}
												if (i_87_ == 5003) {
												...
												if (i_87_ == 5008) {
													...
													Class21.aPacketStream_466.createFrame(i + -43, 222);
													Class21.aPacketStream_466.writeByte(i ^ 0x5c, 0);
													int i_248_ = Class21.aPacketStream_466.anInt2945;
													Class21.aPacketStream_466.writeByte(32, i_246_);
													Class21.aPacketStream_466.writeByte(32, i_247_);
													Class13_Sub2.method258(Class21.aPacketStream_466, i + -124, class100);
													Class21.aPacketStream_466.method935(-i_248_ + Class21.aPacketStream_466.anInt2945, 119);
												    }
												    break;
												}
												if (i_87_ == 5009) {
												    i_89_ -= 2;
												    RSString class100 = Class68_Sub15.aRSStringArray3015[i_89_];
												    RSString class100_249_ = Class68_Sub15.aRSStringArray3015[i_89_ + 1];
												    if (Class68_Sub13_Sub13.anInt3663 != 0 || Class25.anInt517 != 1 && Class30.anInt552 != 1) {
													Class68_Sub13_Sub15.anInt3689++;
													Class21.aPacketStream_466.createFrame(i ^ 0x28, 178);
													Class21.aPacketStream_466.writeByte(32, 0);
													int i_250_ = Class21.aPacketStream_466.anInt2945;
													Class21.aPacketStream_466.method924(true, class100.method1609(i ^ 0x2ae0));
													Class13_Sub2.method258(Class21.aPacketStream_466, 0, class100_249_);
													Class21.aPacketStream_466.method935(-i_250_ + Class21.aPacketStream_466.anInt2945, 126);
												    }
												    break;
												}
												if (i_87_ == 5010) {
												...
												if (i_87_ == 5011) {
													...
													class100 = Class61.aRSStringArray1139[i_252_];
												    if (class100 == null)
													class100 = Class68_Sub13_Sub19.aRSString_3739;
												    Class68_Sub15.aRSStringArray3015[i_89_++] = class100;
												    break;
												...
												if (i_87_ == 5015) {
													...
													class100 = Class68_Sub28_Sub2.aRSString_4551;
												    else
												...
												if (i_87_ == 5050) {
												    ...
												    Class68_Sub15.aRSStringArray3015[i_89_++] = Class14.method267(true, i_255_).aRSString_4342;
												    break;
												}
												...
												if (i_87_ == 5055) {
												    ...
												    Class68_Sub15.aRSStringArray3015[i_89_++] = Class118.method1731(i_263_, (byte) 103).method1088(91);
												    break;
												}
												if (i_87_ == 5056) {
												...
												if (i_87_ == 5059) {
												    Class21.aPacketStream_466.createFrame(i + -218, 250);
												    Class21.aPacketStream_466.writeByte(32, 0);
												    PacketStream.anInt4129++;
												    int i_267_ = Class21.aPacketStream_466.anInt2945;
												    Class21.aPacketStream_466.writeByte(32, 0);
												    Class21.aPacketStream_466.writeWord(false, aClass58_4498.anInt1089);
												...
												if ((i_87_ ^ 0xffffffff) == -5061) {
												    Class105.anInt1797++;
												    RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
												    Class21.aPacketStream_466.createFrame(122, 78);
												    Class21.aPacketStream_466.writeByte(32, 0);
												    int i_268_ = Class21.aPacketStream_466.anInt2945;
												    Class21.aPacketStream_466.method924(true, class100.method1609(10908));
												    Class21.aPacketStream_466.writeWord(false, aClass58_4498.anInt1089);
												    aClass58_4498.aClass68_Sub20_Sub8_1099.method1081(-94, aClass58_4498.anIntArray1090, Class21.aPacketStream_466);
												    Class21.aPacketStream_466.method935(Class21.aPacketStream_466.anInt2945 - i_268_, 120);
												    break;
												}
												if (i_87_ == 5061) {
												    PacketStream.anInt4129++;
												    Class21.aPacketStream_466.createFrame(84, 250);
												    Class21.aPacketStream_466.writeByte(32, 0);
												    int i_269_ = Class21.aPacketStream_466.anInt2945;
												    Class21.aPacketStream_466.writeByte(32, 1);
												    Class21.aPacketStream_466.writeWord(false, aClass58_4498.anInt1089);
												    aClass58_4498.aClass68_Sub20_Sub8_1099.method1081(-90, aClass58_4498.anIntArray1090, Class21.aPacketStream_466);
												    Class21.aPacketStream_466.method935(Class21.aPacketStream_466.anInt2945 - i_269_, i + 2);
												    break;
												}
												if (i_87_ == 5062) {
												    i_85_ -= 2;
												...
												Class68_Sub15.aRSStringArray3015[i_89_++] = method1248(i_289_, (byte) -9).method1076(-1, class68_sub20_sub12.aRSString_4344, i_290_);
											    break;
											}
											...
											if (class68_sub20_sub12.method1155(i + -9))
											    Class68_Sub15.aRSStringArray3015[i_89_++] = Class1_Sub5.method140(84, i_292_).method1705(256, class68_sub20_sub12.aRSString_4344, i_291_);
											else
										    ...
										    if (class68_sub20_sub12.method1155(115))
											Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub13_Sub11.method753(i_293_, -97).method1440(0, class68_sub20_sub12.aRSString_4344, i_294_);
										    else
										...
										if ((Class45.anInt917 ^ 0xffffffff) != -3 || i_333_ >= Class32.anInt573)
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub13_Sub38.aRSStringArray4084[i_333_];
										break;
									    }
									    if (i_87_ == 3602) {
										...
										RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
										Class68_Sub20_Sub13.method1157((byte) 122, class100.method1609(10908));
										break;
									    }
									    if ((i_87_ ^ 0xffffffff) == -3607) {
										RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
										Class68_Sub13_Sub15.method766(23136, class100.method1609(10908));
										break;
									    }
									    if (i_87_ == 3607) {
										RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
										Class51.method536(class100.method1609(10908), (byte) -124);
										break;
									    }
									    if ((i_87_ ^ 0xffffffff) == -3609) {
										RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
										Class92.method1531(-126, class100.method1609(10908));
										break;
									    }
										...
										if (Class45.anInt917 != 2 || (Class32.anInt573 ^ 0xffffffff) >= (i_337_ ^ 0xffffffff))
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub1.aRSStringArray2754[i_337_];
										break;
									    }
									    if (i_87_ == 3611) {
										if (Class69.aRSString_1251 == null)
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class69.aRSString_1251.method1597(i + 12564);
										break;
									    }
									    if (i_87_ == 3612) {
										if (Class69.aRSString_1251 != null)
										...
										if (Class69.aRSString_1251 == null || i_338_ >= Class68_Sub20_Sub8.anInt4278)
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub13_Sub2.aClass68_Sub19Array4630[i_338_].aRSString_3073.method1597(12688);
										break;
									    }
										...
										RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
										Class107.method1649(-256, class100.method1609(10908));
										break;
									    }
										...
										if ((Class45.anInt917 ^ 0xffffffff) == -1 || Class68_Sub13_Sub26.anInt3880 <= i_341_)
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class56.method570(Class21_Sub1.aLongArray2703[i_341_], -1).method1597(Class15.method278(i, 12780));
										break;
									    }
									    if (i_87_ == 3623) {
										RSString class100 = Class68_Sub15.aRSStringArray3015[--i_89_];
										...
										if (Class90.aRSString_2351 == null)
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class90.aRSString_2351.method1597(12688);
										break;
									    }
									    if (i_87_ == 3626) {
										...
										if (Class69.aRSString_1251 == null || Class68_Sub20_Sub8.anInt4278 <= i_343_)
										    ...
										    Class68_Sub15.aRSStringArray3015[i_89_++] = Class68_Sub20_Sub13_Sub2.aClass68_Sub19Array4630[i_343_].aRSString_3076;
										break;
									    }
									    if (i_87_ == 3627) {
									...
									if (i_87_
									    ...
									    Class68_Sub15.aRSStringArray3015[i_89_++] = class68_sub20_sub3.method1047((byte) -106, i_345_);
									    break;
									}
									if ((i_87_
									     ^ 0xffffffff)
										...
										Class68_Sub15.aRSStringArray3015[i_89_++] = class68_sub20_sub3.method1047((byte) -127, i_349_);
									    else
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class50.method533(i_356_, -11143, i_355_);
									break;
								    }
								    if (i_87_
									== 3302) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub13_Sub35.method876(i_358_, i_357_, 20558);
									break;
								    }
								    if (i_87_
									== 3303) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub20_Sub11.method1148(0, i_359_, i_360_);
									break;
								    }
								    if ((i_87_
									 ^ 0xffffffff)
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class125.method1763((byte) 106, i_361_).anInt4181;
									break;
								    }
								    if (i_87_
									== 3305) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class1_Sub5.anIntArray2516[i_364_];
									break;
								    }
								    if ((i_87_
									 ^ 0xffffffff)
									...
									int i_365_
									    = Class61.anInt1149;
									int i_366_
									    = Class36.anInt643 + (Class68_Sub7.aClass1_Sub6_Sub2_2860.anInt2561 >> -432924825);
									int i_367_
									    = (Class68_Sub7.aClass1_Sub6_Sub2_2860.anInt2537
									       >> 530465479) - -Class68_Sub13_Sub35.anInt4026;
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = (i_366_
									       << 774299694) + (i_365_ << -1828576740) - -i_367_;
									break;
								    }
								    if ((i_87_
									 ^ 0xffffffff)
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class120.method1740(i_368_ >> 839738350, 16383);
									break;
								    }
								    if (i_87_
									== 3310) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class120.method1740(16383, i_370_);
									break;
								    }
								    if (i_87_
									== 3312) {
									...
									i_85_ -= 2;
									int i_371_
									    = Class68_Sub13.anIntArray2924[i_85_] + 32768;
									int i_372_
									    = Class68_Sub13.anIntArray2924[i_85_ - -1];
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class50.method533(i_372_, i + -11267, i_371_);
									break;
								    }
								    if (i_87_
									== 3314) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub13_Sub35.method876(i_374_, i_373_, 20558);
									break;
								    }
								    if (i_87_
									== 3315) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub20_Sub11.method1148(0, i_376_, i_375_);
									break;
								    }
								    if ((i_87_
									 ^ 0xffffffff)
									== -3317) {
									if ((Class68_Sub13_Sub13.anInt3663
									     ^ 0xffffffff)
									    > -3)
									    Class68_Sub13.anIntArray2924[i_85_++] = 0;
									else
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub7.aClass1_Sub6_Sub2_2860.anInt3415;
									break;
								    }
								    if ((i_87_
									 ^ 0xffffffff)
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub7.aClass1_Sub6_Sub2_2860.aClass126_3410.aBoolean2196 ? 1 : 0;
									break;
								    }
								    if ((i_87_
									 ^ 0xffffffff)
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class68_Sub20_Sub3.method1051(2, i_377_);
									break;
								    }
								    if (i_87_
									== 3331) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class96.method1556(false, i_379_, i_378_, 0);
									break;
								    }
								    if (i_87_
									== 3332) {
									...
									Class68_Sub13
									    .anIntArray2924
									    [i_85_++]
									    = Class96.method1556(true, i_381_, i_380_, 0);
									break;
								    }
								    if (i_87_
									== 3333) {
								...
								if ((i_87_
									...
									((byte) -111))
									i_382_
									    = class100.method1619((byte) -62);
								    Class21.aPacketStream_466.createFrame(-99, 43);
								    Class21.aPacketStream_466.writeDWord(i ^ 0x2074fcc4, i_382_);
								    break;
								}
								if ((i_87_
								     ^ 0xffffffff)
									...
									= (Class68_Sub15
									   .aRSStringArray3015
									   [--i_89_]);
								    Class21.aPacketStream_466.createFrame(-113, 189);
								    Class21
									.aPacketStream_466
									.method924
									(true,
								...
								if ((i_87_
									...
									= (Class68_Sub15
									   .aRSStringArray3015
									   [--i_89_]);
								    Class21.aPacketStream_466.createFrame(-122, 127);
								    Class21
									.aPacketStream_466
									.writeByte
									(32,
								...
								if ((i_87_
									...
									= (Class68_Sub13
									   .anIntArray2924
									   [--i_85_]);
								    Class21.aPacketStream_466.createFrame(58, 195);
								    Class21
									.aPacketStream_466
									.writeWord
									(false,
					...
					if (i_87_ == 1300) {
					    int i_392_ = -1 + (Class68_Sub13
							       .anIntArray2924
							       [--i_85_]);
					    if ((i_392_ ^ 0xffffffff) > -1
						|| (i_392_ ^ 0xffffffff) < -10)
						i_89_--;
					    else
						class45.method496
						    (i_392_,
					...
					if (i_87_ == 1301) {
						...
						= (Class68_Sub13.anIntArray2924
						   [i_85_ - -1]);
					    class45.aClass45_893
						= Class66.method637(i_393_,
								    false,
								    i_394_);
					    break;
					}
				    ...
				    if ((i_87_ ^ 0xffffffff) == -1201
					|| i_87_ == 1205) {
					i_85_ -= 2;
					int i_395_ = (Class68_Sub13
						      .anIntArray2924[i_85_]);
					int i_396_
					    = (Class68_Sub13.anIntArray2924
					       [i_85_ - -1]);
					if (i_395_ == -1) {
					    ...
					    class45.anInt814
						= class19.anInt395;
					    if ((class45.anInt793 ^ 0xffffffff)
						>= -1) {
						if ((class45.anInt773
						     ^ 0xffffffff)
						    < -1)
				...
				if (i_87_ == 1100) {
				    ...
				    class45.anInt847
					= Class68_Sub13.anIntArray2924[i_85_];
				    if ((class45.anInt888 - class45.anInt892
					 ^ 0xffffffff)
					> (class45.anInt847 ^ 0xffffffff))
					class45.anInt847
					    = (class45.anInt888
					       - class45.anInt892);
					...
					= (Class68_Sub13.anIntArray2924
					   [1 + i_85_]);
				    if (-class45.anInt873 + class45.anInt794
					< class45.anInt818)
					class45.anInt818
					    = (-class45.anInt873
					       + class45.anInt794);
				...
				if ((i_87_ ^ 0xffffffff) == -1111) {
				    int i_397_ = (Class68_Sub13.anIntArray2924
						  [--i_85_]);
				...
				if ((i_87_ ^ 0xffffffff) == -1113) {
					...
					= (Class68_Sub15.aRSStringArray3015
					   [--i_89_]);
				    if (!class100.method1593((class45
							      .aRSString_881),
							     (byte) 127)) {
				...
				Class45 class45
				    = Class68_Sub20_Sub15
					  .method1170(i_398_, (byte) -80);
				if (class45.aClass45Array769 == null)
				    class45.aClass45Array769
					= new Class45[1 + i_400_];
				if ((class45.aClass45Array769.length
				     ^ 0xffffffff)
				    >= (i_400_ ^ 0xffffffff)) {
				    Class45[] class45s
					= new Class45[1 + i_400_];
				    for (int i_401_ = 0;
					 ...
					 i_401_++)
					class45s[i_401_]
					    = class45.aClass45Array769[i_401_];
				    class45.aClass45Array769 = class45s;
				}
				if ((i_400_ ^ 0xffffffff) < -1
				    && (class45.aClass45Array769[-1 + i_400_]
					== null))
				...
				class45_402_.anInt799
				    = class45_402_.anInt792 = class45.anInt792;
				class45_402_.aBoolean863 = true;
				class45_402_.anInt867 = i_400_;
				class45.aClass45Array769[i_400_]
				    = class45_402_;
				if (!bool)
				...
				Class45 class45_403_
				    = (Class68_Sub20_Sub15.method1170
				       (class45.anInt792, (byte) -80));
				class45_403_.aClass45Array769[class45.anInt867]
				    = null;
				...
				int i_405_
				    = Class68_Sub13.anIntArray2924[1 + i_85_];
				Class45 class45
				    = Class66.method637(i_404_, false, i_405_);
				if (class45 != null
				    && (i_405_ ^ 0xffffffff) != 0) {
				    Class68_Sub13.anIntArray2924[i_85_++] = 1;
				    if (!bool)
		...
		if (class68_sub20_sub14.aRSString_4369 == null) {
			...
			Class48.method520(Class68_Sub13_Sub19.aRSString_3739,
					  ...
					  0);
		    Class71.method1339(("CS2 - scr:"
					+ class68_sub20_sub14.aLong1218
					+ " op:" + i_87_),
				       exception, 38);
		} else {
		    RSString class100 = Class21.method339(-18982, 30);
		    class100.method1618(Class124.aRSString_2154, 12147)
			.method1618
			(class68_sub20_sub14.aRSString_4369, i ^ 0x2f0f);
		    for (int i_407_ = Class76.anInt1355 + -1; i_407_ >= 0;
			 i_407_--)
			class100.method1618
			    (Class68_Sub20_Sub4.aRSString_4219, 12147)
			    .method1618
			    ((Class68_Sub13_Sub9.aClass43Array3570[i_407_]
			      .aClass68_Sub20_Sub14_733.aRSString_4369),
			     12147);
		    if (i_87_ == 40) {
			int i_408_ = is[i_86_];
			class100.method1618
			    (Class68_Sub22.aRSString_3135, 12147).method1618
			    (Class68_Sub13_Sub24.method816(i_408_, 0), 12147);
		    }
		    if ((Class75_Sub3.anInt3328 ^ 0xffffffff) != -1)
			Class48.method520(Class68_Sub13_Sub19.aRSString_3739,
					  i ^ ~0x21,
					  (Class68_Sub20_Sub13_Sub2.method1166
					   (2, (new RSString[]
						{ Class59.aRSString_1111,
						  (class68_sub20_sub14
						   .aRSString_4369) }))),
					  0);
		    Class71.method1339
			(("CS2 - scr:" + class68_sub20_sub14.aLong1218 + " op:"
			  + i_87_
			  + new String(class100.method1575((byte) -79))),
			 exception, 38);
		}
	    }
	}
	...
	if (bool == true) {
		...
		while ((aClass10_4467.anIntArray182[i] ^ 0xffffffff)
		       == (i_410_ ^ 0xffffffff)) {
	...
	for (int i_413_ = 0; (i_413_ ^ 0xffffffff) > -17; i_413_++)
	    anIntArray4485[i_413_]
		= Class120.method1740(-128, anIntArray4494[i_413_]);
    }
