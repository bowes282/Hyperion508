...
public class Class1_Sub7 extends Class1
{
    ...
    public static Class21 aClass21_2618;
    ...
    public Class1 method167(boolean bool, int i) {
	anInt2608++;
    ...
    public static void method169(int i, int i_15_, int i_16_, int i_17_,
				 Class1 class1, long l, Class1 class1_18_,
				 Class1 class1_19_) {
	...
	Class1 class1 = method166(675116226);
	anInt2607++;
	if (class1 != null) {
    ...
    public Class1_Sub7(int i, int i_40_, int i_41_, int i_42_, int i_43_,
		       int i_44_, int i_45_, boolean bool, Class1 class1) {
	anInt2599 = -1;
	anInt2592 = -32768;
	anInt2609 = i_43_;
	anInt2614 = i_44_;
