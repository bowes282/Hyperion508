    ...
    implements Runnable, FocusListener, WindowListener
{
	...
	do {
		...
		Class108.aFrame1832.setTitle("Berky-Scape - The Massive Online game by Berky and Hussein");
		...
		Class108.aFrame1832.setSize((insets.left
					     + (Class68_Sub20_Sub17.anInt4437
						+ insets.right)),
					    (Class21.anInt479 - -insets.top
					     + insets.bottom));
		Class85.aSignLink_1553 = Class75_Sub1_Sub1.aSignLink_4589
		    = new SignLink(true, null, i_12_, string, i_10_);
