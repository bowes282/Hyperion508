...
public class Class68_Sub13_Sub36 extends Class68_Sub13
{
    ...
    public static boolean method880(int i, int i_6_, Class21 class21,
				    int i_7_) {
	anInt4030++;
	...
	if (i == -62
	    ...
	    int i_24_ = 0;
	    long l = class100.method1609(10908);
	    if ((l ^ 0xffffffffffffffffL) != -1L) {
		for (/**/;
		...
		if ((i_24_
			...
			!= null)) {
		    Class21.aPacketStream_466.createFrame(111, 200);
		    Class75_Sub2.anInt3316++;
		    Class21.aPacketStream_466.method924
