...
public class client extends Applet_Sub1
{
    ...
    public static Class21 aClass21_2380;
	...
	if (Class126.aClass61_2190 != null) {
	    Class126.aClass61_2190.method594(-67);
	...
	if (Class1.aClass35_66 != null)
	    Class1.aClass35_66.method431(7759444);
	...
	if (Class107.anInt1815 == 0) {
	    ...
	    int i_3_ = (int) ((runtime.totalMemory() + -runtime.freeMemory())
			      / 1024L);
	    long l = Class36.method438(i ^ 0x434d);
	    if ((Class75_Sub1.aLong3304 ^ 0xffffffffffffffffL) == -1L)
		Class75_Sub1.aLong3304 = l;
	    if (i_3_ > 16384 && (l - Class75_Sub1.aLong3304
				 ^ 0xffffffffffffffffL) > -5001L) {
		if ((-Class1_Sub6_Sub1.aLong3392 + l ^ 0xffffffffffffffffL)
		    < -1001L) {
		    System.gc();
		...
		Class68_Sub29.aRSString_3235
		    = Class68_Sub13_Sub5.aRSString_3517;
		Class68_Sub13_Sub28.anInt3917 = 5;
	    }
	} else if ((Class107.anInt1815 ^ 0xffffffff) == -11) {
	    Class1_Sub6_Sub2.method157(4, 104, 104, 25);
	    for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > -5; i_4_++)
		Class109.aClass38Array1843[i_4_] = new Class38(104, 104);
	    Class68_Sub13_Sub28.anInt3917 = 10;
	    Class68_Sub29.aRSString_3235
		= Class68_Sub13_Sub26_Sub1.aRSString_4603;
	    Class107.anInt1815 = 30;
	} else if ((Class107.anInt1815 ^ 0xffffffff) == -31) {
	    Class68_Sub28_Sub1.aClass21_Sub1_4519
		= Class72.method1355((byte) 116, false, true, 0, true);
	    Class58.aClass21_Sub1_1097
		= Class72.method1355((byte) 57, false, true, 1, true);
	    Class68_Sub6.aClass21_Sub1_2843
		= Class72.method1355((byte) 66, true, false, 2, true);
	    Class68_Sub13_Sub21.aClass21_Sub1_3804
		= Class72.method1355((byte) -73, false, true, 3, true);
	    Class78.aClass21_Sub1_1388
		= Class72.method1355((byte) 105, false, true, 4, true);
	    Class92.aClass21_Sub1_1644
		= Class72.method1355((byte) 71, true, true, 5, true);
	    Class21.aClass21_Sub1_459
		= Class72.method1355((byte) -111, true, true, 6, false);
	    Class120.aClass21_Sub1_2095
		= Class72.method1355((byte) -117, false, true, 7, true);
	    Class52.aClass21_Sub1_1011
		= Class72.method1355((byte) 102, false, true, 8, true);
	    Class68_Sub13_Sub30.aClass21_Sub1_3953
		= Class72.method1355((byte) -93, false, true, 9, true);
	    Class84.aClass21_Sub1_1532
		= Class72.method1355((byte) 50, false, true, 10, true);
	    Class21.aClass21_Sub1_472
		= Class72.method1355((byte) -121, false, true, 11, true);
	    Class13.aClass21_Sub1_221
		= Class72.method1355((byte) 107, false, true, 12, true);
	    Class63.aClass21_Sub1_1173
		= Class72.method1355((byte) -99, false, true, 13, true);
	    Class68_Sub20_Sub4.aClass21_Sub1_4217
		= Class72.method1355((byte) -89, false, true, 14, false);
	    Class28.aClass21_Sub1_529
		= Class72.method1355((byte) -75, false, true, 15, true);
	    Class7.aClass21_Sub1_136
		= Class72.method1355((byte) 94, false, true, 16, true);
	    Class33.aClass21_Sub1_583
		= Class72.method1355((byte) -114, false, true, 17, true);
	    Class68.aClass21_Sub1_1228
		= Class72.method1355((byte) 74, false, true, 18, true);
	    Class55.aClass21_Sub1_2038
		= Class72.method1355((byte) -95, false, true, 19, true);
	    Class57.aClass21_Sub1_1068
		= Class72.method1355((byte) 57, false, true, 20, true);
	    Class68_Sub13_Sub31.aClass21_Sub1_3971
		= Class72.method1355((byte) -81, false, true, 21, true);
	    Class14.aClass21_Sub1_229
		= Class72.method1355((byte) 88, false, true, 22, true);
	    Class68_Sub20_Sub5.aClass21_Sub1_4221
		= Class72.method1355((byte) 70, true, true, 23, true);
	    Class68_Sub13_Sub5.aClass21_Sub1_3522
		= Class72.method1355((byte) -109, false, true, 24, true);
	    Class38.aClass21_Sub1_659
		= Class72.method1355((byte) -90, false, true, 25, true);
	    PacketStream.aClass21_Sub1_4133
		= Class72.method1355((byte) 65, true, true, 26, true);
	    ...
	    int i_5_ = 0;
	    i_5_ += (Class68_Sub28_Sub1.aClass21_Sub1_4519.method365(i + -13)
		     * 4 / 100);
	    i_5_ += 4 * Class58.aClass21_Sub1_1097.method365(-88) / 100;
	    i_5_ += Class68_Sub6.aClass21_Sub1_2843.method365(-76) / 100;
	    i_5_ += (2 * Class68_Sub13_Sub21.aClass21_Sub1_3804.method365(65)
		     / 100);
	    ...
	    i_5_ += (Class68_Sub13_Sub30.aClass21_Sub1_3953.method365(87) * 2
		     / 100);
	    ...
	    i_5_ += (2 * Class68_Sub20_Sub4.aClass21_Sub1_4217.method365(58)
		     / 100);
	    ...
	    i_5_ += (Class68_Sub20_Sub5.aClass21_Sub1_4221.method365(i + -175)
		     / 100);
	    i_5_ += Class68_Sub13_Sub5.aClass21_Sub1_3522.method365(-96) / 100;
	    i_5_ += Class38.aClass21_Sub1_659.method365(-95) / 100;
		...
		if (i_5_ != 0)
			...
			= (Class68_Sub20_Sub13_Sub2.method1166
			   (2, (new RSString[]
				{ Class68_Sub13_Sub5.aRSString_3520,
		...
		= Class55.method1717(Class75_Sub1_Sub1.aSignLink_4589,
	    ...
	    Class1.aClass35_66.method425(false,
					 Class80.aClass68_Sub28_Sub4_1418);
	    Class68_Sub20.aClass95_3079
		= new Class95(22050, Class93.anInt1660);
	    Class68_Sub13_Sub15.anInt3681
		= Class21.aClass21_Sub1_459.method335(RSString.aRSString_2297,
						      (byte) -84);
	    ...
	    int i_6_
		= Class68_Sub13_Sub7.method731(Class52.aClass21_Sub1_1011, 53,
					       Class63.aClass21_Sub1_1173);
		...
		Class68_Sub29.aRSString_3235
		    = Class68_Sub13_Sub29.aRSString_3940;
	    }
	} else if (Class107.anInt1815 == 60) {
	    int i_8_
		= Class81.method1454((byte) -126, Class52.aClass21_Sub1_1011);
	    int i_9_ = Class38.method457(false);
	    if ((i_8_ ^ 0xffffffff) > (i_9_ ^ 0xffffffff)) {
		Class68_Sub29.aRSString_3235
		    = (Class68_Sub20_Sub13_Sub2.method1166
		       (2,
			(new RSString[]
			 { Class74.aRSString_1331,
			   Class68_Sub13_Sub24.method816(100 * i_8_ / i_9_, 0),
			   Class68_Sub20_Sub7.aRSString_4267 })));
		Class68_Sub13_Sub28.anInt3917 = 40;
	    } else {
		Class68_Sub29.aRSString_3235
		    = Class68_Sub13_Sub36.aRSString_4049;
		Class68_Sub13_Sub28.anInt3917 = 40;
	    ...
	    Class38.aClass21_Sub1_659.method353((byte) -62);
	    i_10_ += Class38.aClass21_Sub1_659.method352(i + -68);
	    if (i_10_ < 1000) {
		Class68_Sub29.aRSString_3235
		    = (Class68_Sub20_Sub13_Sub2.method1166
		       (2, (new RSString[]
			    { Class68_Sub28_Sub1.aRSString_4509,
		...
		Class68_Sub13_Sub38.method898(Class38.aClass21_Sub1_659,
					      (Class68_Sub13_Sub5
					       .aClass21_Sub1_3522),
					      new Class51(), (byte) -117);
		Class21.method348(Class68_Sub13_Sub5.aClass21_Sub1_3522,
				  (byte) -72, Class38.aClass21_Sub1_659);
		Class68_Sub13_Sub28.anInt3917 = 50;
	    ...
	    int i_11_
		= Class68_Sub13_Sub17.method783(0, Class52.aClass21_Sub1_1011);
		...
		Class90 class90
		    = new Class90(Class68_Sub13_Sub30.aClass21_Sub1_3953,
				  PacketStream.aClass21_Sub1_4133,
		...
		Class75_Sub1_Sub1.aSignLink_4589
		    .method558((byte) -61, 10, Class14.aClass84_241);
		...
		if (!Class84.aClass21_Sub1_1532.method362((byte) 124,
		    ...
		    Class68_Sub29.aRSString_3235
			= (Class68_Sub20_Sub13_Sub2.method1166
			   (2, new RSString[] { RSString.aRSString_2317,
						Class95.aRSString_1691 }));
		    Class68_Sub13_Sub28.anInt3917 = 80;
		} else {
		    Class103 class103
			= new Class103(Class84.aClass21_Sub1_1532.method351
		    ...
		    Class68_Sub29.aRSString_3235
			= Class68_Sub13_Sub29.aRSString_3939;
		    Class68_Sub13_Sub28.anInt3917 = 80;
		}
	    } else if (Class107.anInt1815 == 130) {
		if (!Class68_Sub13_Sub21.aClass21_Sub1_3804
			 .method353((byte) -62)) {
		    Class68_Sub29.aRSString_3235
			= (Class68_Sub20_Sub13_Sub2.method1166
			   (2, (new RSString[]
				{ Class13_Sub1.aRSString_2633,
				  (Class68_Sub13_Sub24.method816
				   (3 * Class68_Sub13_Sub21
					    .aClass21_Sub1_3804
					    .method352(0) / 4,
				    0)),
				  Class68_Sub20_Sub7.aRSString_4267 })));
			...
			= (Class68_Sub20_Sub13_Sub2.method1166
			   (2,
			    (new RSString[]
			     { Class13_Sub1.aRSString_2633,
			       (Class68_Sub13_Sub24.method816
				((Class63.aClass21_Sub1_1173.method352(i + -68)
				  / 20) + 85,
				 i + -68)),
			       Class68_Sub20_Sub7.aRSString_4267 })));
		    Class68_Sub13_Sub28.anInt3917 = 85;
		} else if (!Class68_Sub20_Sub5.aClass21_Sub1_4221
				.method354(0, Class81.aRSString_1481)) {
		    Class68_Sub29.aRSString_3235
			= (Class68_Sub20_Sub13_Sub2.method1166
			   (i + -66,
			    (new RSString[]
			     { Class13_Sub1.aRSString_2633,
			       (Class68_Sub13_Sub24.method816
				((Class68_Sub20_Sub5.aClass21_Sub1_4221
				      .method363(126, Class81.aRSString_1481)
				  / 10) + 90,
				 0)),
			       Class68_Sub20_Sub7.aRSString_4267 })));
		    Class68_Sub13_Sub28.anInt3917 = 85;
		    ...
		    Class68_Sub29.aRSString_3235
			= Class68_Sub13_Sub19.aRSString_3740;
		}
	    } else if ((Class107.anInt1815 ^ 0xffffffff) == -141) {
		Class124.anInt2139
		    = (Class68_Sub13_Sub21.aClass21_Sub1_3804.method335
		       (Class68_Sub10.aRSString_2901, (byte) -106));
	...
	if (this.method26((byte) -106)) {
		...
		RSString class100
		    = Class68_Sub13_Sub27.method842(is.length, is, 127, 0);
		boolean bool = Class68_Sub13_Sub26_Sub1.method833((byte) -101,
								  class100);
		if (bool)
		    Applet_Sub1.aRSString_31 = class100;
	    }
	    Class68_Sub9.aString2883 = this.getCodeBase().getHost();
	...
	for (int i_17_ = 0; i_17_ < i; i_17_++) {
	    class45
		= Class68_Sub20_Sub15.method1170(class45.anInt799, (byte) -80);
	    if (class45 == null)
		return null;
	}
	return class45;
	...
	for (Class43.anInt739 = 0;
	     ...
	     Class43.anInt739++) {
	    Class68_Sub20_Sub14.anIntArray4385[Class43.anInt739]
		= Class59.anInt1104;
	...
	if (Class68_Sub13_Sub10.anInt3595 != -1)
	    Class25.method384(-59, Class68_Sub13_Sub10.anInt3595,
			      Class13_Sub3.anInt2668, 0, 0, 0, 0,
			      Class68_Sub13_Sub9.anInt3568);
	Class68_Sub22.anInt3148++;
	Class30.method404((byte) 113);
	for (;;) {
	    Class68_Sub29 class68_sub29
		= (Class68_Sub29) Class35.aClass16_623.method294(-120);
	    if (class68_sub29 == null)
		break;
	    Class45 class45 = class68_sub29.aClass45_3239;
	    if (class45.anInt867 >= 0) {
		Class45 class45_18_
		    = Class68_Sub20_Sub15.method1170(class45.anInt799,
						     (byte) -80);
		if (class45_18_ == null || class45_18_.aClass45Array769 == null
		    || class45_18_.aClass45Array769.length <= class45.anInt867
		    || (class45
			!= class45_18_.aClass45Array769[class45.anInt867]))
		    continue;
	    }
	...
	for (;;) {
	    Class68_Sub29 class68_sub29
		= (Class68_Sub29) Class13_Sub1.aClass16_2627.method294(54);
	    if (class68_sub29 == null)
		break;
	    Class45 class45 = class68_sub29.aClass45_3239;
		...
		Class45 class45_19_
		    = Class68_Sub20_Sub15.method1170(class45.anInt799,
						     (byte) -80);
		if (class45_19_ == null || class45_19_.aClass45Array769 == null
		    || ((class45.anInt867 ^ 0xffffffff)
			<= (class45_19_.aClass45Array769.length ^ 0xffffffff))
		    || (class45_19_.aClass45Array769[class45.anInt867]
			!= class45))
		    continue;
	    }
	...
	for (;;) {
	    Class68_Sub29 class68_sub29
		= (Class68_Sub29) Class115.aClass16_1955.method294(103);
	    if (class68_sub29 == null)
		break;
	    Class45 class45 = class68_sub29.aClass45_3239;
	    if (class45.anInt867 >= 0) {
		Class45 class45_20_
		    = Class68_Sub20_Sub15.method1170(class45.anInt799,
						     (byte) -80);
		if (class45_20_ == null || class45_20_.aClass45Array769 == null
		    || class45.anInt867 >= class45_20_.aClass45Array769.length
		    || (class45
			!= class45_20_.aClass45Array769[class45.anInt867]))
		    continue;
	    }
	...
	if (i == 2 && RuntimeException_Sub1.anInt2231 != 1000) {
		...
		Class68_Sub13_Sub26.aRandom3873
		    .setSeed((long) Class68_Sub13_Sub4.anInt3509);
	    }
	    method39((byte) -122);
		...
		} else if (((RuntimeException_Sub1.anInt2231 ^ 0xffffffff)
			    == -26)
			   || ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff)
			       == -29))
		    Class61.method598(94);
	    } else {
		method35((byte) 68);
		...
		if (RuntimeException_Sub1.anInt2231 != 30) {
			...
			Login.method1463(false);
			if ((Class68_Sub20_Sub7.anInt4257 ^ 0xffffffff) != 2) {
			    if ((Class68_Sub20_Sub7.anInt4257 ^ 0xffffffff)
				!= -16) {
	...
	Class68_Sub10 class68_sub10
	    = ((Class68_Sub10)
	       Class106.aClass113_1803.method1678((((long) class45.anInt792
						    << 32)
						   + (long) class45.anInt867),
						  109));
	...
	if (i == 0) {
		...
		if ((Class13_Sub2.anInt2652-- ^ 0xffffffff) >= -1) {
			...
			try {
				...
				Class68_Sub13_Sub9.aClass31_3575
				    = (Class75_Sub1_Sub1.aSignLink_4589
					   .method559
				       (Class68_Sub9.aString2883, (byte) 115,
					Class103.anInt1773));
				Class84.anInt1540++;
			    }
			    if (Class84.anInt1540 == 1) {
				if (Class68_Sub13_Sub9.aClass31_3575.anInt555
				    == 2) {
				    method44(-5, -1);
				    break;
				}
				...
				Class109.aClass61_1846
				    = new Class61((Socket) (Class68_Sub13_Sub9
							    .aClass31_3575
							    .anObject558),
						  (Class75_Sub1_Sub1
						   .aSignLink_4589));
				Stream class68_sub14
				    = new Stream(5);
				class68_sub14.writeByte(32, 15);
				class68_sub14.writeDWord(544537784, 508);
				Class109.aClass61_1846.method590
				    (0, (byte) 82, 5,
				     class68_sub14.aByteArray2960);
				Class84.anInt1540++;
				Class1_Sub6.aLong2585
				    = Class36.method438(17161);
			    }
			    if (Class84.anInt1540 == 3) {
				if ((RuntimeException_Sub1.anInt2231
				     ^ 0xffffffff) != -1
				    && RuntimeException_Sub1.anInt2231 != 5
				    && (Class109.aClass61_1846
					    .method597((byte) 102)
					^ 0xffffffff) >= -1) {
				    if (((Class36.method438(i + 17161)
					  + -Class1_Sub6.aLong2585)
					 ^ 0xffffffffffffffffL)
					< -30001L) {
					method44(i + -5, -2);
				    ...
				    int i_22_
					= Class109.aClass61_1846.method593(96);
			    ...
			    boolean bool
				= (RuntimeException_Sub1.anInt2231 == 5
				   || (RuntimeException_Sub1.anInt2231
				       ^ 0xffffffff) == -11
				   || (RuntimeException_Sub1.anInt2231
				       ^ 0xffffffff) == -29);
			    Class113.method1685(Class109.aClass61_1846, false,
						!bool);
			    Class127.anInt2209 = 0;
			    Class68_Sub13_Sub9.aClass31_3575 = null;
			    Class84.anInt1540 = 0;
			    Class109.aClass61_1846 = null;
			} catch (java.io.IOException ioexception) {
			    method44(-5, -3);
			    break;
			}
	...
	for (int i_29_ = 0; i_29_ < class45s.length; i_29_++) {
		...
		&& (!class45.aBoolean863 || class45.anInt896 == 0
		    || class45.aBoolean851 || method41(class45) != 0
		    || class45 == Class68_Sub13_Sub26_Sub1.aClass45_4607
		    || class45.anInt808 == 1338)
		&& (!class45.aBoolean863 || !method45(class45))) {
		...
		if (!class45.aBoolean863 || i_32_ < i_34_ && i_33_ < i_35_) {
			...
			if (!class45.aBoolean863 && method45(class45)
			    && Class108.aClass45_1825 != class45)
			    continue;
			if (class45.aBoolean916 && Class96.anInt1695 >= i_32_
			    && Class13.anInt223 >= i_33_
			    && Class96.anInt1695 < i_34_
			    && Class13.anInt223 < i_35_) {
			    for (Class68_Sub29 class68_sub29
				     = ((Class68_Sub29)
					Class115.aClass16_1955
					    .method293((byte) 76));
				 class68_sub29 != null;
				 class68_sub29
				     = ((Class68_Sub29)
			...
			if (Class29.anInt537 == 1
			    && Class68_Sub13_Sub37.anInt4077 >= i_32_
			    && Class125.anInt2173 >= i_33_
			    && Class68_Sub13_Sub37.anInt4077 < i_34_
			    && Class125.anInt2173 < i_35_)
			    bool_39_ = true;
			if (Class43.anInt739 > 0
			    && class45.aByteArray907 != null) {
			    for (int i_40_ = 0;
				...
				for (int i_41_ = 0; i_41_ < Class43.anInt739;
				     i_41_++) {
				    int i_42_
					= class45.aByteArray907[i_40_] & 0xff;
				    if (i_42_ == (Class68_Sub20_Sub14
						  .anIntArray4385[i_41_]))
			...
			if (bool_39_)
			    Class91.method1523((Class68_Sub13_Sub37.anInt4077
						- i_30_),
					       Class125.anInt2173 - i_31_,
					       -4798, class45);
			if (Class35.aClass45_606 != null
			    && Class35.aClass45_606 != class45 && bool
			    && Class68_Sub13_Sub19
				   .method794(32157, method41(class45)))
			    Class1.aClass45_61 = class45;
			if (class45
			...
			if (class45.aBoolean851 || class45.anInt808 != 0) {
				...
				|| (class45.anInt808 != 1400
				    && Class68_Sub10.aBoolean2903)) {
				bool_39_ = false;
				bool_38_ = false;
				bool = false;
			    }
				...
				if (class45.anInt808 == 1338) {
				    if (bool_39_)
					Class68_Sub20_Sub11.method1149
					    (99, class45,
					     Class125.anInt2173 - i_31_,
				...
				if (class45.anInt808 == 1400) {
					...
					if (Class128.aBooleanArray2228[82]
					    && (Class68_Sub13_Sub13.anInt3663
						> 0)) {
					    int i_43_
						= (int) ((double) ((Class68_Sub13_Sub37
								    .anInt4077)
								   - i_30_
								   - ((class45
								       .anInt892)
						...
						= (int) ((double) ((Class125
							 ...
							 * 2.0
							 / (double) (Class68_Sub9
								     .aFloat2892));
					    int i_45_ = ((Class68_Sub13_Sub24
							  .anInt3844)
							 + i_43_);
					    int i_46_
						= Class85.anInt1551 + i_44_;
					    int i_47_
						= i_45_ + Class70.anInt1273;
					    int i_48_
						...
						= Class85.anInt1551;
					       ...
					       && Class68_Sub10.aBoolean2903) {
					Class68_Sub8.method675
					    ((Applet_Sub1.anInt2
					      + (int) ((double) ((Class68_Sub13_Sub25
								  .anInt3853)
								 - (Class96
								    .anInt1695))
						       * 2.0
						       / (double) (Class68_Sub13_Sub27
								   .aFloat3913))),
					     -1);
					Class68_Sub13_Sub12.method754
					    ((Class80.anInt1445
					      + (int) ((double) ((Class58
								  .anInt1087)
								 - (Class13
				...
				if (class45.anInt808 == 1401) {
				    if (bool_38_)
					Class68_Sub17.method991
					    (class45.anInt873, false,
				...
				if (class45.anObjectArray788 != null) {
				    ...
				    Class115.aClass16_1955
					.method286(class68_sub29, true);
				}
			    }
			    if (class45.aBoolean850 && bool_38_
				&& class45.anObjectArray911 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aBoolean3242 = true;
				class68_sub29.aClass45_3239 = class45;
				...
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray878;
				Class35.aClass16_623.method286(class68_sub29,
							       true);
			    }
			    if (class45.anObjectArray875 != null
				&& Class13_Sub1.anInt2639 > class45.anInt879) {
				if (class45.anIntArray900 == null
				    || (Class13_Sub1.anInt2639
					- class45.anInt879) > 32) {
				    Class68_Sub29 class68_sub29
					= new Class68_Sub29();
				    class68_sub29.aClass45_3239 = class45;
				    class68_sub29.anObjectArray3237
					= class45.anObjectArray875;
				    Class115.aClass16_1955
					.method286(class68_sub29, true);
				} else {
				while_1_:
				    for (int i_49_ = class45.anInt879;
					 ...
					 i_49_++) {
					int i_50_ = (Class125.anIntArray2169
						     [i_49_ & 0x1f]);
					for (int i_51_ = 0;
					     (i_51_
					      < class45.anIntArray900.length);
					     i_51_++) {
					    if (class45.anIntArray900[i_51_]
						== i_50_) {
						Class68_Sub29 class68_sub29
						    = new Class68_Sub29();
						class68_sub29.aClass45_3239
						    = class45;
						class68_sub29.anObjectArray3237
						    = class45.anObjectArray875;
						Class115.aClass16_1955
			    ...
			    if (class45.anObjectArray835 != null
				&& (Class68_Sub10.anInt2908
				    > class45.anInt877)) {
				if (class45.anIntArray780 == null
				    || (Class68_Sub10.anInt2908
					- class45.anInt877) > 32) {
				    Class68_Sub29 class68_sub29
					= new Class68_Sub29();
				...
				while_2_:
					...
					int i_53_
					    = (Class68_Sub13_Sub31
					       .anIntArray3970[i_52_ & 0x1f]);
					for (int i_54_ = 0;
					     (i_54_
					      < class45.anIntArray780.length);
					     i_54_++) {
					    if (class45.anIntArray780[i_54_]
						== i_53_) {
						Class68_Sub29 class68_sub29
						    = new Class68_Sub29();
						class68_sub29.aClass45_3239
			    ...
			    if (class45.anObjectArray786 != null
				&& Class68_Sub4.anInt2815 > class45.anInt855) {
				if (class45.anIntArray787 == null
				    || (Class68_Sub4.anInt2815
					- class45.anInt855) > 32) {
				    Class68_Sub29 class68_sub29
					= new Class68_Sub29();
				    class68_sub29.aClass45_3239 = class45;
				    class68_sub29.anObjectArray3237
					= class45.anObjectArray786;
				    Class115.aClass16_1955
					.method286(class68_sub29, true);
				} else {
				while_3_:
					...
					int i_56_
					    = (Class68_Sub13_Sub34
					       .anIntArray4012[i_55_ & 0x1f]);
					for (int i_57_ = 0;
					     (i_57_
					      < class45.anIntArray787.length);
					     i_57_++) {
					    if (class45.anIntArray787[i_57_]
						== i_56_) {
						Class68_Sub29 class68_sub29
						    = new Class68_Sub29();
						class68_sub29.aClass45_3239
			    ...
			    if (class45.anObjectArray837 != null
				&& (Class68_Sub29.anInt3243
				    > class45.anInt889)) {
				if (class45.anIntArray887 == null
				    || (Class68_Sub29.anInt3243
					- class45.anInt889) > 32) {
				    Class68_Sub29 class68_sub29
					= new Class68_Sub29();
				...
				while_4_:
					...
					int i_59_
					    = (Class68_Sub13_Sub39
					       .anIntArray4102[i_58_ & 0x1f]);
					for (int i_60_ = 0;
					     (i_60_
					      < class45.anIntArray887.length);
					     i_60_++) {
					    if (class45.anIntArray887[i_60_]
						== i_59_) {
						Class68_Sub29 class68_sub29
						    = new Class68_Sub29();
						class68_sub29.aClass45_3239
			    ...
			    if (class45.anObjectArray861 != null
				&& Class30.anInt544 > class45.anInt839) {
				if (class45.anIntArray891 == null
				    || (Class30.anInt544 - class45.anInt839
					> 32)) {
				    Class68_Sub29 class68_sub29
					= new Class68_Sub29();
				...
				while_5_:
					...
					int i_62_
					    = (Class68_Sub13_Sub36
					       .anIntArray4044[i_61_ & 0x1f]);
					for (int i_63_ = 0;
					     (i_63_
					      < class45.anIntArray891.length);
					     i_63_++) {
					    if (class45.anIntArray891[i_63_]
						== i_62_) {
						Class68_Sub29 class68_sub29
						    = new Class68_Sub29();
						class68_sub29.aClass45_3239
			    ...
			    if (Class68_Sub20_Sub3.anInt4196 > class45.anInt836
				&& class45.anObjectArray812 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray812;
				Class115.aClass16_1955.method286(class68_sub29,
								 true);
			    }
			    if (Class123.anInt2130 > class45.anInt836
				&& class45.anObjectArray843 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray843;
				Class115.aClass16_1955.method286(class68_sub29,
								 true);
			    }
			    if (Class68_Sub28_Sub2.anInt4547 > class45.anInt836
				&& class45.anObjectArray871 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray871;
				Class115.aClass16_1955.method286(class68_sub29,
								 true);
			    }
			    if (Class4.anInt93 > class45.anInt836
				&& class45.anObjectArray872 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray872;
				Class115.aClass16_1955.method286(class68_sub29,
								 true);
			    }
			    if (Class68_Sub20_Sub5.anInt4220 > class45.anInt836
				&& class45.anObjectArray874 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray874;
				Class115.aClass16_1955.method286(class68_sub29,
								 true);
			    }
				...
				for (int i_64_ = 0; i_64_ < Class43.anInt739;
					...
					= new Class68_Sub29();
				    class68_sub29.aClass45_3239 = class45;
				    class68_sub29.anInt3230
					= (Class68_Sub20_Sub14.anIntArray4385
					   [i_64_]);
				    class68_sub29.anInt3241
					= Class50.anIntArray983[i_64_];
				    class68_sub29.anObjectArray3237
					= class45.anObjectArray868;
				    Class115.aClass16_1955
					.method286(class68_sub29, true);
				}
			    }
			    if (RSString.aBoolean2279
				&& class45.anObjectArray801 != null) {
				Class68_Sub29 class68_sub29
				    = new Class68_Sub29();
				class68_sub29.aClass45_3239 = class45;
				class68_sub29.anObjectArray3237
				    = class45.anObjectArray801;
				Class115.aClass16_1955.method286(class68_sub29,
								 true);
			    }
			}
		    }
		    if (!class45.aBoolean863 && Class35.aClass45_606 == null
			&& Class54.aClass45_1033 == null
			&& !Class120.aBoolean2099) {
			if ((class45.anInt844 >= 0 || class45.anInt828 != 0)
			    && Class96.anInt1695 >= i_32_
			    && Class13.anInt223 >= i_33_
			    && Class96.anInt1695 < i_34_
			    && Class13.anInt223 < i_35_) {
			    if (class45.anInt844 >= 0)
				Class108.aClass45_1825
				    = class45s[class45.anInt844];
			    else
				Class108.aClass45_1825 = class45;
			}
			if (class45.anInt896 == 8 && Class96.anInt1695 >= i_32_
			    && Class13.anInt223 >= i_33_
			    && Class96.anInt1695 < i_34_
			    && Class13.anInt223 < i_35_)
			...
			Class68_Sub3 class68_sub3
			    = ((Class68_Sub3)
				   ...
				   .method1678((long) class45.anInt792, 84));
	...
	Class68_Sub13_Sub26.method831(Class75_Sub1_Sub1.aSignLink_4589,
				      (byte) -104, Class75_Sub2.aBoolean3314);
	...
	if (Class68_Sub13_Sub34.anInt4008 != 1) {
		...
		= Class68_Sub20_Sub19.aShortArrayArray4455;
	    Class68_Sub13_Sub35.aShortArray4023
		= Class68_Sub13_Sub20.aShortArray3779;
	    Class56.aShortArrayArray1065
		= Class68_Sub13_Sub12.aShortArrayArray3629;
	} else {
	...
	try {
		...
		Class68_Sub20_Sub10.aClass124_4318
		    = new Class124((Class75_Sub1_Sub1.aSignLink_4589
				    .aClass2_1045),
				   5200, 0);
		for (int i_66_ = 0; (i_66_ ^ 0xffffffff) > -28; i_66_++)
		    Class26.aClass124Array520[i_66_]
			= new Class124((Class75_Sub1_Sub1.aSignLink_4589
					.aClass2Array1039[i_66_]),
				       6000, 0);
		Class75_Sub2.aClass124_3311
		    = new Class124((Class75_Sub1_Sub1.aSignLink_4589
				    .aClass2_1057),
				   6000, 0);
		Class43.aClass89_734
		    = new Class89(255, Class68_Sub20_Sub10.aClass124_4318,
				  Class75_Sub2.aClass124_3311, 500000);
		Class68_Sub13_Sub4.aClass124_3486
		    = new Class124((Class75_Sub1_Sub1.aSignLink_4589
				    .aClass2_1041),
				   24, 0);
    ...
    public void method44(int i, int i_67_) {
	anInt2369++;
	if (i != -5)
	    method27(-31);
	Class68_Sub13_Sub9.aClass31_3575 = null;
	...
	if ((Class103.anInt1773 ^ 0xffffffff)
	    == (Class115.anInt1946 ^ 0xffffffff))
	    Class103.anInt1773 = Class68_Sub15.anInt3013;
	else
	    Class103.anInt1773 = Class115.anInt1946;
	Class127.anInt2209++;
	Class109.aClass61_1846 = null;
	if ((Class127.anInt2209 ^ 0xffffffff) > -3
	    || (i_67_ ^ 0xffffffff) != -8 && i_67_ != 9) {
		...
		if ((Class127.anInt2209 ^ 0xffffffff) <= -5) {
			...
			this.method16(690, "js5connect");
			RuntimeException_Sub1.anInt2231 = 1000;
		    }
		}
	    } else {
		this.method16(690, "js5connect_outofdate");
		RuntimeException_Sub1.anInt2231 = 1000;
	    }
	} else if ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff) == -1
		   || (RuntimeException_Sub1.anInt2231 ^ 0xffffffff) == -6) {
	    this.method16(i ^ ~0x2b6, "js5connect_full");
	    RuntimeException_Sub1.anInt2231 = 1000;
	} else
	    Class13_Sub2.anInt2652 = 3000;
    }
	...
	if (RuntimeException_Sub1.anInt2231 != 1000) {
	    ...
	    if (bool && Class123.aBoolean2127
		&& Class68_Sub13_Sub36.aClass35_4035 != null)
		...
		|| RuntimeException_Sub1.anInt2231 == 10) {
		if (!Class68_Sub13_Sub21.aBoolean3796) {
		    if (Class36.aLong644 != 0L
			&& ((Class36.method438(17161) ^ 0xffffffffffffffffL)
			    < (Class36.aLong644 ^ 0xffffffffffffffffL)))
			Class44.method485(-1);
		} else
		    Class44.method485(-1);
	    }
	    if ((Class81.aLong1480 ^ 0xffffffffffffffffL) != -1L
		&& ((Class36.method438(17161) ^ 0xffffffffffffffffL)
		    < (Class81.aLong1480 ^ 0xffffffffffffffffL))
		&& Class126.aClass61_2190 != null
		&& (RuntimeException_Sub1.anInt2231 == 30
		...
		if ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff) != -11) {
		    if ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff) != -26
			&& ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff)
			    != -29)) {
			if (RuntimeException_Sub1.anInt2231 != 30) {
			    if ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff)
				== -41)
				Class74.method1381
				    (false,
				     (Class68_Sub20_Sub13_Sub2.method1166
				      (2, (new RSString[]
					   { Class72.aRSString_1306,
					     Class118.aRSString_2081,
					     Class55.aRSString_2053 }))),
				     -16678);
			} else
			    Class68_Sub13_Sub25.method821(true);
		    } else if ((Class21.anInt480 ^ 0xffffffff) != -2) {
			if ((Class21.anInt480 ^ 0xffffffff) != -3)
			...
			if (Class50_Sub2.anInt2745
			    < Class68_Sub13_Sub19.anInt3748)
			    Class50_Sub2.anInt2745
				= Class68_Sub13_Sub19.anInt3748;
			int i_70_ = (50
				     * (Class50_Sub2.anInt2745
					+ -Class68_Sub13_Sub19.anInt3748)
		...
		Class68_Sub7.method665((Class68_Sub13_Sub4
					.aClass68_Sub20_Sub1_3511),
				       -27931);
	    if ((RuntimeException_Sub1.anInt2231 == 30
		 || (RuntimeException_Sub1.anInt2231 ^ 0xffffffff) == -11)
		&& (Class68_Sub20_Sub5.anInt4229 ^ 0xffffffff) == -1
		&& !bool_68_) {
		try {
		    Graphics graphics = Class86.aCanvas1585.getGraphics();
		    for (int i_71_ = 0; ((Class56.anInt1061 ^ 0xffffffff)
					 < (i_71_ ^ 0xffffffff)); i_71_++) {
			if (Class68_Sub17.aBooleanArray3037[i_71_]) {
			    Class1_Sub5.aClass72_2496.method1359
				(graphics, true, ItemDef.anIntArray376[i_71_],
	...
	try {
		...
		if (strings[7].equals("safemode"))
		    ...
		    Class21.method329(127);
	    } else
		Class75_Sub2.aBoolean3314 = false;
	    Class68_Sub9.aString2883 = JOptionPane.showInputDialog(null,"Please enter IP address:");
	    Class26.aRSString_521 = Class68_Sub28_Sub2.aRSString_4556;
	    Class68_Sub13_Sub20.anInt3780 = 0;
	    client var_client = new client();
	    var_client.method21(765, 503, 109, 27, "runescape", 508,
				32 - -Class13_Sub4.anInt2690);
